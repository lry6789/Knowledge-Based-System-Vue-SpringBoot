...
!function (t, e) {
    ...
    function r() {
        ...
        var i = Array(t), r = 0;
        for (e = 0; e < n; e++) for (var o = arguments[e], a = 0, s = o.length; a < s; a++, r++) i[r] = o[a];
        return i
    }
    ...
    var o = function () {
        ...
        this.browser = new o, this.node = !1, this.wxa = !1, this.worker = !1, this.canvasSupported = !1, this.svgSupported = !1, this.touchEventsSupported = !1, this.pointerEventsSupported = !1, this.domSupported = !1
    };
    "object" == typeof wx && "function" == typeof wx.getSystemInfoSync ? (a.wxa = !0, a.canvasSupported = !0, a.touchEventsSupported = !0) : "undefined" == typeof document && "undefined" != typeof self ? (a.worker = !0, a.canvasSupported = !0) : "undefined" == typeof navigator ? (a.node = !0, a.canvasSupported = !0, a.svgSupported = !0) : function (t, e) {
        ...
        a && (n.weChat = !0);
        e.canvasSupported = !!document.createElement("canvas").getContext, e.svgSupported = "undefined" != typeof SVGRect, e.touchEventsSupported = "ontouchstart" in window && !n.ie && !n.edge, e.pointerEventsSupported = "onpointerdown" in window && (n.edge || n.ie && +n.version >= 11), e.domSupported = "undefined" != typeof document
    ...
    var s = {
        ...
        }, u = Object.prototype.toString, h = Array.prototype, c = h.forEach, p = h.filter, d = h.slice, f = h.map,
        g = function () {
        }.constructor, y = g ? g.prototype : null, v = {};
    ...
    function w(t) {
        ...
        if ("[object Array]" === n) {
            if (!lt(t)) {
                e = [];
                for (var i = 0, r = t.length; i < r; i++) e[i] = w(t[i])
            }
        } else if (l[n]) {
            if (!lt(t)) {
                var o = t.constructor;
                if (o.from) e = o.from(t); else {
                    e = new o(t.length);
                    for (i = 0, r = t.length; i < r; i++) e[i] = w(t[i])
                }
            }
        } else if (!s[n] && !lt(t) && !j(t)) for (var a in e = {}, t) t.hasOwnProperty(a) && (e[a] = w(t[a]));
        return e
    }

    function S(t, e, n) {
        if (!X(e) || !X(t)) return n ? w(e) : t;
        for (var i in e) if (e.hasOwnProperty(i)) {
            var r = t[i], o = e[i];
            !X(o) || !X(r) || F(o) || F(r) || j(o) || j(r) || U(o) || U(r) || lt(o) || lt(r) ? !n && i in t || (t[i] = w(e[i])) : S(r, o, n)
        }
        return t
    }

    function M(t, e) {
        for (var n = t[0], i = 1, r = t.length; i < r; i++) n = S(n, t[i], e);
        return n
    }
    ...
    function P(t, e, n) {
        if (t && e) if (t.forEach && t.forEach === c) t.forEach(e, n); else if (t.length === +t.length) for (var i = 0, r = t.length; i < r; i++) e.call(n, t[i], i, t); else for (var o in t) t.hasOwnProperty(o) && e.call(n, t[o], o, t)
    }
    ...
    function N(t, e, n) {
        if (!t) return [];
        if (!e) return nt(t);
        if (t.filter && t.filter === p) return t.filter(e, n);
    ...
    v.createCanvas = function () {
        return document.createElement("canvas")
    };
    var B = y && G(y.bind) ? y.call.bind(y.bind) : function (t, e) {
    ...
    function F(t) {
        return Array.isArray ? Array.isArray(t) : "[object Array]" === u.call(t)
    }
    ...
    var ut = function () {
        function t(e) {
            ...
            e instanceof t ? e.each(r) : e && P(e, r)
        }
    ...
    var zt = Object.freeze({
        ...
        return t.prototype._dragStart = function (t) {
            ...
            e && (this._draggingTarget = e, e.dragging = !0, this._x = t.offsetX, this._y = t.offsetY, this.handler.dispatchToElement(new Bt(e, t), "dragstart", t.event))
        }, t.prototype._drag = function (t) {
            var e = this._draggingTarget;
            if (e) {
                var n = t.offsetX, i = t.offsetY, r = n - this._x, o = i - this._y;
                this._x = n, this._y = i, e.drift(r, o, t), this.handler.dispatchToElement(new Bt(e, t), "drag", t.event);
                var a = this.handler.findHover(n, i, e).target, s = this._dropTarget;
                this._dropTarget = a, e !== a && (s && a !== s && this.handler.dispatchToElement(new Bt(s, t), "dragleave", t.event), a && a !== s && this.handler.dispatchToElement(new Bt(a, t), "dragenter", t.event))
            }
        }, t.prototype._dragEnd = function (t) {
            var e = this._draggingTarget;
            e && (e.dragging = !1), this.handler.dispatchToElement(new Bt(e, t), "dragend", t.event), this._dropTarget && this.handler.dispatchToElement(new Bt(this._dropTarget, t), "drop", t.event), this._draggingTarget = null, this._dropTarget = null
        }, t
    }(), Ft = function () {
        function t(t) {
        ...
        return t.prototype.on = function (t, e, n, i) {
            ...
            if (e) for (var i = arguments, r = i.length, o = i[r - 1], a = e.length, s = 0; s < a; s++) {
                var l = e[s];
    ...
    function Xt(t, e, n, i, r) {
        if (e.getBoundingClientRect && a.domSupported && !Ut(e)) {
            var o = e.___zrEVENTSAVED || (e.___zrEVENTSAVED = {}), s = function (t, e, n) {
                ...
                return l && r ? r : (e.srcCoords = a, e[i] = n ? Wt(s, a) : Wt(a, s))
            }(function (t, e) {
                var n = e.markers;
                if (n) return n;
                n = e.markers = [];
    ...
    var Zt = "undefined" != typeof window && !!window.addEventListener,
        jt = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, qt = [];

    function Kt(t, e, n, i) {
        return n = n || {}, i || !a.canvasSupported ? $t(t, e, n) : a.browser.firefox && null != e.layerX && e.layerX !== e.offsetX ? (n.zrX = e.layerX, n.zrY = e.layerY) : null != e.offsetX ? (n.zrX = e.offsetX, n.zrY = e.offsetY) : $t(t, e, n), n
    }

    function $t(t, e, n) {
        if (a.domSupported && t.getBoundingClientRect) {
            var i = e.clientX, r = e.clientY;
            if (Ut(t)) {
                var o = t.getBoundingClientRect();
                return n.zrX = i - o.left, void (n.zrY = r - o.top)
            }
            if (Xt(qt, t, i, r)) return n.zrX = qt[0], void (n.zrY = qt[1])
        }
        n.zrX = n.zrY = 0
    }
    ...
    function Qt(t, e, n) {
        ...
        var a = e.button;
        return null == e.which && void 0 !== a && jt.test(e.type) && (e.which = 1 & a ? 1 : 2 & a ? 3 : 4 & a ? 2 : 0), e
    }

    function te(t, e, n, i) {
        Zt ? t.addEventListener(e, n, i) : t.attachEvent("on" + e, n)
    }

    var ee = Zt ? function (t) {
    ...
    var ie = function () {
        ...
        return t.prototype.recognize = function (t, e, n) {
            ...
            for (var e in oe) if (oe.hasOwnProperty(e)) {
                var n = oe[e](this._track, t);
                if (n) return n
            }
        }, t
    }();
    ...
    var le = function (t) {
        ...
        ce = function (t) {
            function e(e, n, i, r) {
                ...
                return o._hovered = new ue(0, 0), o.storage = e, o.painter = n, o.painterRoot = r, i = i || new le, o.proxy = null, o.setHandlerProxy(i), o._draggingMgr = new Vt(o), o
            }

            return n(e, t), e.prototype.setHandlerProxy = function (t) {
                this.proxy && this.proxy.dispose(), t && (P(he, (function (e) {
                    t.on && t.on(e, this[e], this)
                }), this), t.handler = this), this.proxy = t
            }, e.prototype.mousemove = function (t) {
                var e = t.zrX, n = t.zrY, i = de(this, e, n), r = this._hovered, o = r.target;
                o && !o.__zr && (o = (r = this.findHover(r.x, r.y)).target);
                var a = this._hovered = i ? new ue(e, n) : this.findHover(e, n), s = a.target, l = this.proxy;
                ...
                for (var i = this.storage.getDisplayList(), r = new ue(t, e), o = i.length - 1; o >= 0; o--) {
                    var a = void 0;
                    if (i[o] !== n && !i[o].ignore && (a = pe(i[o], t, e)) && (!r.topTarget && (r.topTarget = i[o]), a !== ae)) {
                        r.target = i[o];
                        break
                    }
                }
                ...
                this._gestureMgr || (this._gestureMgr = new ie);
    ...
    P(["click", "mousedown", "mouseup", "mousewheel", "dblclick", "contextmenu"], (function (t) {
        ce.prototype[t] = function (e) {
            var n, i, r = e.zrX, o = e.zrY, a = de(this, r, o);
            if ("mouseup" === t && a || (i = (n = this.findHover(r, o)).target), "mousedown" === t) this._downEl = i, this._downPoint = [e.zrX, e.zrY], this._upEl = i; else if ("mouseup" === t) this._upEl = i; else if ("click" === t) {
                if (this._downEl !== this._upEl || !this._downPoint || Lt(this._downPoint, [e.zrX, e.zrY]) > 4) return;
    ...
    var Ce = [], Ae = [], De = [1, 0, 0, 1, 0, 0], Le = Math.abs, ke = function () {
        function t() {
        }
        ...
        return t.prototype.setPosition = function (t) {
            ...
            return Te(this.rotation) || Te(this.x) || Te(this.y) || Te(this.scaleX - 1) || Te(this.scaleY - 1)
        }, t.prototype.updateTransform = function () {
            var t = this.parent, e = t && t.transform, n = this.needLocalTransform(), i = this.transform;
            n || e ? (i = i || [1, 0, 0, 1, 0, 0], n ? this.getLocalTransform(i) : Me(i), e && (n ? ve(i, t.transform, i) : ye(i, t.transform)), this.transform = i, this._resolveGlobalScaleRatio(i)) : i && Me(i)
        }, t.prototype._resolveGlobalScaleRatio = function (t) {
            var e = this.globalScaleRatio;
            if (null != e && 1 !== e) {
                this.getGlobalScale(Ce);
                var n = Ce[0] < 0 ? -1 : 1, i = Ce[1] < 0 ? -1 : 1, r = ((Ce[0] - n) * e + n) / Ce[0] || 0,
                    o = ((Ce[1] - i) * e + i) / Ce[1] || 0;
                t[0] *= r, t[1] *= r, t[2] *= o, t[3] *= o
            }
            this.invTransform = this.invTransform || [1, 0, 0, 1, 0, 0], be(this.invTransform, t)
            ...
            if (t) {
                ...
                Te(e - 1) && (e = Math.sqrt(e)), Te(n - 1) && (n = Math.sqrt(n)), t[0] < 0 && (e = -e), t[3] < 0 && (n = -n), this.rotation = Math.atan2(-t[1] / n, t[0] / e), e < 0 && n < 0 && (this.rotation += Math.PI, e = -e, n = -n), this.x = t[4], this.y = t[5], this.scaleX = e, this.scaleY = n
            }
        }, t.prototype.decomposeTransform = function () {
            if (this.transform) {
                var t = this.parent, e = this.transform;
                t && t.transform && (ve(Ae, t.invTransform, e), e = Ae);
                var n = this.originX, i = this.originY;
                (n || i) && (De[4] = n, De[5] = i, ve(Ae, e, De), Ae[4] -= n, Ae[5] -= i, e = Ae), this.setLocalTransform(e)
            }
            ...
            return t && Le(t[0] - 1) > 1e-10 && Le(t[3] - 1) > 1e-10 ? Math.sqrt(Le(t[0] * t[3] - t[2] * t[1])) : 1
        }, t.getLocalTransform = function (t, e) {
            Me(e = e || []);
            var n = t.originX || 0, i = t.originY || 0, r = t.scaleX, o = t.scaleY, a = t.rotation || 0, s = t.x,
                l = t.y;
            return e[4] -= n, e[5] -= i, e[0] *= r, e[1] *= o, e[2] *= r, e[3] *= o, e[4] *= r, e[5] *= o, a && _e(e, e, a), e[4] += n, e[5] += i, e[4] += s, e[5] += l, e
        ...
        linear: function (t) {
            ...
            return 1 - Pe.bounceOut(1 - t)
        }, bounceOut: function (t) {
            return t < 1 / 2.75 ? 7.5625 * t * t : t < 2 / 2.75 ? 7.5625 * (t -= 1.5 / 2.75) * t + .75 : t < 2.5 / 2.75 ? 7.5625 * (t -= 2.25 / 2.75) * t + .9375 : 7.5625 * (t -= 2.625 / 2.75) * t + .984375
        }, bounceInOut: function (t) {
            return t < .5 ? .5 * Pe.bounceIn(2 * t) : .5 * Pe.bounceOut(2 * t - 1) + .5
        }
    }, Oe = function () {
        function t(t) {
            this._initialized = !1, this._startTime = 0, this._pausedTime = 0, this._paused = !1, this._life = t.life || 1e3, this._delay = t.delay || 0, this.loop = null != t.loop && t.loop, this.gap = t.gap || 0, this.easing = t.easing || "linear", this.onframe = t.onframe, this.ondestroy = t.ondestroy, this.onrestart = t.onrestart
        }
        ...
        return t.prototype.step = function (t, e) {
            if (this._initialized || (this._startTime = t + this._delay, this._initialized = !0), !this._paused) {
                ...
                var i = this.easing, r = "string" == typeof i ? Pe[i] : i, o = "function" == typeof r ? r(n) : n;
        ...
        function t(t) {
            this._list = new Ne, this._maxSize = 10, this._map = {}, this._maxSize = t
        }
        ...
        return t.prototype.put = function (t, e) {
            ...
            if (null == i[t]) {
                ...
                a ? a.value = e : a = new Re(e), a.key = t, n.insertEntry(a), i[t] = a
            }
            return r
    ...
    function Fe(t) {
        var e = t;
        return e.length && "%" === e.charAt(e.length - 1) ? Be(parseFloat(e) / 100 * 255) : Be(parseInt(e, 10))
    }

    function Ge(t) {
        var e = t;
        return e.length && "%" === e.charAt(e.length - 1) ? Ve(parseFloat(e) / 100) : Ve(parseFloat(e))
    }
    ...
    var Ue = new Ee(20), Ze = null;

    function je(t, e) {
        Ze && Xe(Ze, e), Ze = Ue.put(t, Ze || e.slice())
    }
    ...
    function qe(t, e) {
        if (t) {
            ...
            if (i in ze) return Xe(e, ze[i]), je(t, e), e;
            var r, o = i.length;
            if ("#" === i.charAt(0)) return 4 === o || 5 === o ? (r = parseInt(i.slice(1, 4), 16)) >= 0 && r <= 4095 ? (Ye(e, (3840 & r) >> 4 | (3840 & r) >> 8, 240 & r | (240 & r) >> 4, 15 & r | (15 & r) << 4, 5 === o ? parseInt(i.slice(4), 16) / 15 : 1), je(t, e), e) : void Ye(e, 0, 0, 0, 1) : 7 === o || 9 === o ? (r = parseInt(i.slice(1, 7), 16)) >= 0 && r <= 16777215 ? (Ye(e, (16711680 & r) >> 16, (65280 & r) >> 8, 255 & r, 9 === o ? parseInt(i.slice(7), 16) / 255 : 1), je(t, e), e) : void Ye(e, 0, 0, 0, 1) : void 0;
            var a = i.indexOf("("), s = i.indexOf(")");
            if (-1 !== a && s + 1 === o) {
                var l = i.substr(0, a), u = i.substr(a + 1, s - (a + 1)).split(","), h = 1;
                switch (l) {
                    case"rgba":
                        if (4 !== u.length) return 3 === u.length ? Ye(e, +u[0], +u[1], +u[2], 1) : Ye(e, 0, 0, 0, 1);
                        h = Ge(u.pop());
                    case"rgb":
                        return 3 !== u.length ? void Ye(e, 0, 0, 0, 1) : (Ye(e, Fe(u[0]), Fe(u[1]), Fe(u[2]), h), je(t, e), e);
                    case"hsla":
                        return 4 !== u.length ? void Ye(e, 0, 0, 0, 1) : (u[3] = Ge(u[3]), Ke(u, e), je(t, e), e);
                    case"hsl":
                        return 3 !== u.length ? void Ye(e, 0, 0, 0, 1) : (Ke(u, e), je(t, e), e);
                    default:
                        return
                }
            }
    ...
    function Ke(t, e) {
        var n = (parseFloat(t[0]) % 360 + 360) % 360 / 360, i = Ge(t[1]), r = Ge(t[2]),
            o = r <= .5 ? r * (i + 1) : r + i - r * i, a = 2 * r - o;
        return Ye(e = e || [], Be(255 * He(a, o, n + 1 / 3)), Be(255 * He(a, o, n)), Be(255 * He(a, o, n - 1 / 3)), 1), 4 === t.length && (e[3] = t[3]), e
    }
    ...
    function $e(t, e) {
        ...
        if (n) {
            ...
            return an(n, 4 === n.length ? "rgba" : "rgb")
        }
    }
    ...
    function Qe(t, e, n) {
        if (e && e.length && t >= 0 && t <= 1) {
            ...
            return n[0] = Be(We(a[0], s[0], l)), n[1] = Be(We(a[1], s[1], l)), n[2] = Be(We(a[2], s[2], l)), n[3] = Ve(We(a[3], s[3], l)), n
        }
    }
    ...
    function en(t, e, n) {
        if (e && e.length && t >= 0 && t <= 1) {
            var i = t * (e.length - 1), r = Math.floor(i), o = Math.ceil(i), a = qe(e[r]), s = qe(e[o]), l = i - r,
                u = an([Be(We(a[0], s[0], l)), Be(We(a[1], s[1], l)), Be(We(a[2], s[2], l)), Ve(We(a[3], s[3], l))], "rgba");
    ...
    function rn(t, e, n, i) {
        ...
        }(e)), null != n && (r[1] = Ge(n)), null != i && (r[2] = Ge(i)), an(Ke(r), "rgba")
    }

    function on(t, e) {
        var n = qe(t);
        if (n && null != e) return n[3] = Ve(e), an(n, "rgba")
    }
    ...
    function cn(t, e, n, i) {
        for (var r = e.length, o = 0; o < r; o++) t[o] = hn(e[o], n[o], i)
    }
    ...
    function fn(t, e, n) {
        ...
        if (i.push && r.push) {
            ...
            if (o !== a) if (o > a) i.length = a; else for (var s = o; s < a; s++) i.push(1 === n ? r[s] : un.call(r[s]));
    ...
    function vn(t, e, n, i, r, o, a, s) {
        for (var l = e.length, u = 0; u < l; u++) t[u] = yn(e[u], n[u], i[u], r[u], o, a, s)
    }
    ...
    function mn(t) {
        if (k(t)) {
            var e = t.length;
            if (k(t[0])) {
                for (var n = [], i = 0; i < e; i++) n.push(un.call(t[i]));
                return n
            }
            return un.call(t)
        }
    ...
    var xn, bn, wn = [0, 0, 0, 0], Sn = function () {
            function t(t) {
            ...
            return t.prototype.isFinished = function () {
                ...
                if (this.interpolable) if (k(e)) {
                    ...
                    if (i > 0) {
                        var o = n[i - 1];
                        this._isAllValueEqual && (1 === r && gn(e, o.value) || (this._isAllValueEqual = !1))
                    }
                    this.arrDim = r
                } else {
                    ...
                    if (this._isAllValueEqual && i > 0) {
                        o = n[i - 1];
                        (this.isValueColor && !gn(o.value, e) || o.value !== e) && (this._isAllValueEqual = !1)
                    }
                }
                ...
                for (var n = this.arrDim, i = e.length, r = e[i - 1], o = 0; o < i; o++) e[o].percent = e[o].time / this.maxTime, n > 0 && o !== i - 1 && fn(e[o].value, r.value, n);
                if (t && this.needsAnimate() && t.needsAnimate() && n === t.arrDim && this.isValueColor === t.isValueColor && !t._finished) {
                    this._additiveTrack = t;
                    var a = e[0].value;
                    for (o = 0; o < i; o++) 0 === n ? this.isValueColor ? e[o].additiveValue = pn([], e[o].value, a, -1) : e[o].additiveValue = e[o].value - a : 1 === n ? e[o].additiveValue = pn([], e[o].value, a, -1) : 2 === n && (e[o].additiveValue = dn([], e[o].value, a, -1))
                }
                ...
                if (!this._finished) {
                    ...
                    if (e < 0) n = 0; else if (e < this._lastFramePercent) {
                    ...
                    if (c && h) {
                        ...
                        if (0 !== p) {
                            var d = (e - c.percent) / p, f = i ? this._additiveValue : u ? wn : t[s];
                            if ((l > 0 || u) && !f && (f = this._additiveValue = []), this.useSpline) {
                                var g = o[n][r], y = o[0 === n ? n : n - 1][r], v = o[n > a - 2 ? a - 1 : n + 1][r],
                                    m = o[n > a - 3 ? a - 1 : n + 2][r];
                                if (l > 0) 1 === l ? vn(f, y, g, v, m, d, d * d, d * d * d) : function (t, e, n, i, r, o, a, s) {
                                    for (var l = e.length, u = e[0].length, h = 0; h < l; h++) {
                                        t[h] || (t[1] = []);
                                        for (var c = 0; c < u; c++) t[h][c] = yn(e[h][c], n[h][c], i[h][c], r[h][c], o, a, s)
                                    }
                                }(f, y, g, v, m, d, d * d, d * d * d); else if (u) vn(f, y, g, v, m, d, d * d, d * d * d), i || (t[s] = _n(f)); else {
                                    var _ = void 0;
                                    _ = this.interpolable ? yn(y, g, v, m, d, d * d, d * d * d) : v, i ? this._additiveValue = _ : t[s] = _
                                }
                            } else if (l > 0) 1 === l ? cn(f, c[r], h[r], d) : function (t, e, n, i) {
                                for (var r = e.length, o = r && e[0].length, a = 0; a < r; a++) {
                                    t[a] || (t[a] = []);
                                    for (var s = 0; s < o; s++) t[a][s] = hn(e[a][s], n[a][s], i)
                                }
                            }(f, c[r], h[r], d); else if (u) cn(f, c[r], h[r], d), i || (t[s] = _n(f)); else {
                                _ = void 0;
                                _ = this.interpolable ? hn(c[r], h[r], d) : function (t, e, n) {
                                    return n > .5 ? e : t
                                }(c[r], h[r], d), i ? this._additiveValue = _ : t[s] = _
                            }
                ...
                0 === e ? this.isValueColor ? (qe(t[n], wn), pn(wn, wn, i, 1), t[n] = _n(wn)) : t[n] = t[n] + i : 1 === e ? pn(t[n], t[n], i, 1) : 2 === e && dn(t[n], t[n], i, 1)
            }, t
        }(), Mn = function () {
            function t(t, e, n) {
                this._tracks = {}, this._trackKeys = [], this._delay = 0, this._maxTime = 0, this._paused = !1, this._started = 0, this._clip = null, this._target = t, this._loop = e, e && n ? b("Can' use additive animation on looped animation.") : this._additiveAnimators = n
            }
                ...
                for (var i = this._tracks, r = 0; r < n.length; r++) {
                    ...
                    if (!a) {
                        ...
                        if (l) {
                            ...
                            s = u && u.value, l.isValueColor && s && (s = _n(s))
                        } else s = this._target[o];
                        if (null == s) continue;
                        0 !== t && a.addKeyframe(0, mn(s)), this._trackKeys.push(o)
                    }
                    a.addKeyframe(t, mn(e[o]))
                }
        ...
        }(), Tn = Math.min, Cn = Math.max, An = new In, Dn = new In, Ln = new In, kn = new In, Pn = new In, On = new In,
        Rn = function () {
            function t(t, e, n, i) {
                n < 0 && isFinite(n) && (t += n, n = -n), i < 0 && isFinite(i) && (e += i, i = -i), this.x = t, this.y = e, this.width = n, this.height = i
            }

            return t.prototype.union = function (t) {
                var e = Tn(t.x, this.x), n = Tn(t.y, this.y);
                isFinite(this.x) && isFinite(this.width) ? this.width = Cn(t.x + t.width, this.x + this.width) - e : this.width = t.width, isFinite(this.y) && isFinite(this.height) ? this.height = Cn(t.y + t.height, this.y + this.height) - n : this.height = t.height, this.x = e, this.y = n
                ...
                if (n) {
                    ...
                    o < l || u < r ? _ > f && (f = _, g < y ? In.set(On, -g, 0) : In.set(On, y, 0)) : _ < d && (d = _, g < y ? In.set(Pn, g, 0) : In.set(Pn, -y, 0)), s < h || c < a ? x > f && (f = x, v < m ? In.set(On, 0, -v) : In.set(On, 0, m)) : _ < d && (d = _, v < m ? In.set(Pn, 0, v) : In.set(Pn, 0, -m))
                }
                return n && In.copy(n, p ? Pn : On), p
                ...
                if (i) {
                    ...
                    An.x = Ln.x = n.x, An.y = kn.y = n.y, Dn.x = kn.x = n.x + n.width, Dn.y = Ln.y = n.y + n.height, An.transform(i), kn.transform(i), Dn.transform(i), Ln.transform(i), e.x = Tn(An.x, Dn.x, Ln.x, kn.x), e.y = Tn(An.y, Dn.y, Ln.y, kn.y);
                    var l = Cn(An.x, Dn.x, Ln.x, kn.x), u = Cn(An.y, Dn.y, Ln.y, kn.y);
                    e.width = l - e.x, e.height = u - e.y
                } else e !== n && t.copy(e, n)
            }, t
        }(), Nn = {}, En = "12px sans-serif";
    var zn = {
        measureText: function (t, e) {
            return xn || (xn = C().getContext("2d")), bn !== e && (bn = xn.font = e || En), xn.measureText(t)
        }
    };
    ...
    function Bn(t, e) {
        ...
        n || (n = Nn[e] = new Ee(500));
        var i = n.get(t);
        return null == i && (i = zn.measureText(t, e).width, n.put(t, i)), i
    }

    function Vn(t, e, n, i) {
        var r = Bn(t, e), o = Wn(e), a = Gn(0, r, n), s = Hn(0, o, i);
        return new Rn(a, s, r, o)
    }

    function Fn(t, e, n, i) {
        var r = ((t || "") + "").split("\n");
        if (1 === r.length) return Vn(r[0], e, n, i);
        for (var o = new Rn(0, 0, 0, 0), a = 0; a < r.length; a++) {
            var s = Vn(r[a], e, n, i);
    ...
    function Xn(t, e, n) {
        ...
        if (i instanceof Array) l += Yn(i[0], n.width), u += Yn(i[1], n.height), h = null, c = null; else switch (i) {
            case"left":
    ...
    var Un = 1;
    "undefined" != typeof window && (Un = Math.max(window.devicePixelRatio || window.screen && window.screen.deviceXDPI / window.screen.logicalXDPI || 1, 1));
    var Zn = Un, jn = "#333", qn = "#ccc", Kn = "__zr_normal__",
        $n = ["x", "y", "scaleX", "scaleY", "originX", "originY", "rotation", "ignore"],
        Jn = {x: !0, y: !0, scaleX: !0, scaleY: !0, originX: !0, originY: !0, rotation: !0, ignore: !1}, Qn = {},
        ti = new Rn(0, 0, 0, 0), ei = function () {
            function t(t) {
                this.id = x(), this.animators = [], this.currentStates = [], this.states = {}, this._init(t)
            }
            ...
            return t.prototype._init = function (t) {
                ...
                if (e && (!e.ignore || t)) {
                    ...
                    if (r.x = e.x, r.y = e.y, r.originX = e.originX, r.originY = e.originY, r.rotation = e.rotation, r.scaleX = e.scaleX, r.scaleY = e.scaleY, null != n.position) {
                        var u = ti;
                        n.layoutRect ? u.copy(n.layoutRect) : u.copy(this.getBoundingRect()), i || u.applyTransform(this.transform), this.calculateTextPosition ? this.calculateTextPosition(Qn, n, u) : Xn(Qn, n, u), r.x = Qn.x, r.y = Qn.y, o = Qn.align, a = Qn.verticalAlign;
                        var h = n.origin;
                        if (h && null != n.rotation) {
                            var c = void 0, p = void 0;
                            "center" === h ? (c = .5 * u.width, p = .5 * u.height) : (c = Yn(h[0], u.width), p = Yn(h[1], u.height)), l = !0, r.originX = -r.x + c + (i ? 0 : u.x), r.originY = -r.y + p + (i ? 0 : u.y)
                        }
                    }
                ...
                return this.__zr && this.__zr.isDarkMode() ? qn : jn
            }, t.prototype.getOutsideStroke = function (t) {
                var e = this.__zr && this.__zr.getBackgroundColor(), n = "string" == typeof e && qe(e);
                n || (n = [255, 255, 255, 1]);
                ...
                "textConfig" === t ? this.setTextConfig(e) : "textContent" === t ? this.setTextContent(e) : "clipPath" === t ? this.setClipPath(e) : "extra" === t ? (this.extra = this.extra || {}, I(this.extra, e)) : this[t] = e
            }, t.prototype.hide = function () {
                this.ignore = !0, this.markRedraw()
            }, t.prototype.show = function () {
                this.ignore = !1, this.markRedraw()
            }, t.prototype.attr = function (t, e) {
                if ("string" == typeof t) this.attrKV(t, e); else if (X(t)) for (var n = z(t), i = 0; i < n.length; i++) {
                    var r = n[i];
                    this.attrKV(r, t[r])
                }
                ...
                e || (e = this._normalState = {}), t.textConfig && !e.textConfig && (e.textConfig = this.textConfig), this._savePrimaryToNormal(t, e, $n)
                ...
                var i = this.currentStates.slice(), r = A(i, t), o = A(i, e) >= 0;
                ...
                for (var e, n = {}, i = 0; i < t.length; i++) {
                    var r = t[i];
                    I(n, r), r.textConfig && I(e = e || {}, r.textConfig)
                }
                return e && (n.textConfig = e), n
            }, t.prototype._applyStateObj = function (t, e, n, i, r, o) {
                var a = !(e && i);
                e && e.textConfig ? (this.textConfig = I({}, i ? this.textConfig : n.textConfig), I(this.textConfig, e.textConfig)) : a && n.textConfig && (this.textConfig = n.textConfig);
                ...
                if (e !== t) {
                    ...
                    t.attachedTransform = new ke, this._attachComponent(t), this._textContent = t, this.markRedraw()
                }
                ...
                for (var r = ni(this, e, n, i), o = 0; o < r.length; o++) r[o].__fromStateTransition = t
                ...
                var e = t.prototype;
                e.type = "element", e.name = "", e.ignore = !1, e.silent = !1, e.isGroup = !1, e.draggable = !1, e.dragging = !1, e.ignoreClip = !1, e.__inHover = !1, e.__dirty = t.REDARAW_BIT;
                var n = {};

                function i(t, e, i) {
                    n[t + e + i] || (console.warn("DEPRECATED: '" + t + "' has been deprecated. use '" + e + "', '" + i + "' instead"), n[t + e + i] = !0)
                }
                ...
                function r(t, n, r, o) {
                    ...
                    Object.defineProperty(e, t, {
                        get: function () {
                            ...
                            i(t, r, o), this[r] = e[0], this[o] = e[1], this[n] = e, a(this, e)
                        }
                    })
                }

                Object.defineProperty && (!a.browser.ie || a.browser.version > 8) && (r("position", "_legacyPos", "x", "y"), r("scale", "_legacyScale", "scaleX", "scaleY"), r("origin", "_legacyOrigin", "originX", "originY"))
            }(), t
        }();
    ...
    function ri(t, e, n) {
        if (k(e[n])) if (k(t[n]) || (t[n] = []), Z(e[n])) {
            var i = e[n].length;
            t[n].length !== i && (t[n] = new e[n].constructor(i), ii(t[n], e[n], i))
        } else {
            var r = e[n], o = t[n], a = r.length;
            if (k(r[0])) for (var s = r[0].length, l = 0; l < a; l++) o[l] ? ii(o[l], r[l], s) : o[l] = Array.prototype.slice.call(r[l]); else ii(o, r, a);
            o.length = r.length
        } else t[n] = e[n]
    }

    function oi(t, e, n, i, r, o, a, s) {
        for (var l = [], u = [], h = z(i), c = r.duration, p = r.delay, d = r.additive, f = r.setToFinal, g = !X(o), y = 0; y < h.length; y++) {
            if (null != n[I = h[y]] && null != i[I] && (g || o[I])) if (X(i[I]) && !k(i[I])) {
                if (e) {
                    s || (n[I] = i[I], t.updateDuringAnimation(e));
                    continue
                }
                oi(t, I, n[I], i[I], r, o && o[I], a, s)
            } else l.push(I), u.push(I); else s || (n[I] = i[I], t.updateDuringAnimation(e), u.push(I))
        }
        var v = l.length;
        if (v > 0 || r.force && !a.length) {
            for (var m = t.animators, _ = [], x = 0; x < m.length; x++) m[x].targetName === e && _.push(m[x]);
            if (!d && _.length) for (x = 0; x < _.length; x++) {
                if (_[x].stopTracks(u)) {
                    var b = A(m, _[x]);
                    m.splice(b, 1)
                }
            }
            var w = void 0, S = void 0, M = void 0;
            if (s) {
                S = {}, f && (w = {});
                for (x = 0; x < v; x++) {
                    S[I = l[x]] = n[I], f ? w[I] = i[I] : n[I] = i[I]
                }
            } else if (f) {
                M = {};
                for (x = 0; x < v; x++) {
                    var I;
                    M[I = l[x]] = mn(n[I]), ri(n, i, I)
                }
            }
            var T = new Mn(n, !1, d ? _ : null);
            T.targetName = e, r.scope && (T.scope = r.scope), f && w && T.whenWithKeys(0, w, l), M && T.whenWithKeys(0, M, l), T.whenWithKeys(null == c ? 500 : c, s ? S : i, l).delay(p || 0), t.addAnimator(T, e), a.push(T)
        }
    }
    ...
    function hi(t, e) {
        ...
        function s(s) {
            ...
            var p = ui(t[h], t, l, u, 0, e);
            l += p, 0 !== (u -= p) && 0 !== (c = li(t[l + u - 1], t, h, c, c - 1, e)) && (u <= c ? function (n, i, o, s) {
                var l = 0;
    ...
    function ci(t, e, n, i) {
        ...
        if (!(r < 2)) {
            var o = 0;
            if (r < 32) si(t, n, i, n + (o = ai(t, n, i, e)), e); else {
                var a = hi(t, e), s = function (t) {
    ...
    function di() {
        pi || (pi = !0, console.warn("z / z2 / zlevel of displayable is invalid, which may cause unexpected errors"))
    }
    ...
    var gi, yi, vi = function () {
            function t() {
                this._roots = [], this._displayList = [], this._displayListLen = 0, this.displayableSortFunc = fi
            }
            ...
            return t.prototype.traverse = function (t, e) {
                ...
                n.length = this._displayListLen, a.canvasSupported && ci(n, fi)
                ...
                if (!t.ignore || n) {
                    ...
                    if (t.childrenRef) {
                        for (var a = t.childrenRef(), s = 0; s < a.length; s++) {
                            var l = a[s];
                            t.__dirty && (l.__dirty |= ei.REDARAW_BIT), this._updateAndAddDisplayable(l, e, n)
                        }
                        t.__dirty = 0
                    } else {
                        var u = t;
                        e && e.length ? u.__clipPaths = e : u.__clipPaths && u.__clipPaths.length > 0 && (u.__clipPaths = []), isNaN(u.z) && (di(), u.z = 0), isNaN(u.z2) && (di(), u.z2 = 0), isNaN(u.zlevel) && (di(), u.zlevel = 0), this._displayList[this._displayListLen++] = u
                    }
        ...
        mi = "undefined" != typeof window && (window.requestAnimationFrame && window.requestAnimationFrame.bind(window) || window.msRequestAnimationFrame && window.msRequestAnimationFrame.bind(window) || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame) || function (t) {
            ...
            return n(e, t), e.prototype.addClip = function (t) {
                ...
                var t = this;
                this._running = !0, mi((function e() {
                    t._running && (mi(e), !t._paused && t.update())
                }))
                ...
                e = e || {}, this.start();
                var n = new Mn(t, e.loop);
                return this.addAnimator(n), n
            }, e
        }(Ft), xi = a.domSupported, bi = (yi = {
            pointerdown: 1,
            pointerup: 1,
            pointermove: 1,
            pointerout: 1
        }, {
            mouse: gi = ["click", "dblclick", "mousewheel", "wheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
            touch: ["touchstart", "touchend", "touchmove"],
            pointer: O(gi, (function (t) {
                var e = t.replace("mouse", "pointer");
                return yi.hasOwnProperty(e) ? e : t
            }))
        }), wi = ["mousemove", "mouseup"], Si = ["pointermove", "pointerup"], Mi = !1;
    ...
    var Ai = function (t, e) {
        this.stopPropagation = ft, this.stopImmediatePropagation = ft, this.preventDefault = ft, this.type = e.type, this.target = this.currentTarget = t.dom, this.pointerType = e.pointerType, this.clientX = e.clientX, this.clientY = e.clientY
    }, Di = {
        mousedown: function (t) {
            ...
            Ci(this, (t = Qt(this.dom, t)).toElement || t.relatedTarget) || (this.__pointerCapturing && (t.zrEventControl = "no_globalout"), this.trigger("mouseout", t))
        }, wheel: function (t) {
            Mi = !0, t = Qt(this.dom, t), this.trigger("mousewheel", t)
        }, mousewheel: function (t) {
            Mi || (t = Qt(this.dom, t), this.trigger("mousewheel", t))
        }, touchstart: function (t) {
            Ti(t = Qt(this.dom, t)), this.__lastTouchMoment = new Date, this.handler.processGesture(t, "start"), Di.mousemove.call(this, t), Di.mousedown.call(this, t)
        }, touchmove: function (t) {
            Ti(t = Qt(this.dom, t)), this.handler.processGesture(t, "change"), Di.mousemove.call(this, t)
        }, touchend: function (t) {
            Ti(t = Qt(this.dom, t)), this.handler.processGesture(t, "end"), Di.mouseup.call(this, t), +new Date - +this.__lastTouchMoment < 300 && Di.click.call(this, t)
        }, pointerdown: function (t) {
            Di.mousedown.call(this, t)
        }, pointermove: function (t) {
            Ii(t) || Di.mousemove.call(this, t)
        }, pointerup: function (t) {
            Di.mouseup.call(this, t)
        }, pointerout: function (t) {
            Ii(t) || Di.mouseout.call(this, t)
        }
    };
    ...
    var Li = {
        pointermove: function (t) {
            Ii(t) || Li.mousemove.call(this, t)
        }, pointerup: function (t) {
            Li.mouseup.call(this, t)
        }, mousemove: function (t) {
    ...
    function ki(t, e) {
        var n = e.domHandlers;
        a.pointerEventsSupported ? P(bi.pointer, (function (i) {
            Oi(e, i, (function (e) {
                n[i].call(t, e)
            }))
        })) : (a.touchEventsSupported && P(bi.touch, (function (i) {
            Oi(e, i, (function (r) {
        ...
        })), P(bi.mouse, (function (i) {
            Oi(e, i, (function (r) {
                r = Jt(r), e.touching || n[i].call(t, r)
            }))
        })))
    }
    ...
    function Pi(t, e) {
        function n(n) {
            Oi(e, n, (function (i) {
                i = Jt(i), Ci(t, i.target) || (i = function (t, e) {
                    return Qt(t.dom, new Ai(t, e), !0)
                }(t, i), e.domHandlers[n].call(t, i))
            }), {capture: !0})
        }

        a.pointerEventsSupported ? P(Si, n) : a.touchEventsSupported || P(wi, n)
    }

    function Oi(t, e, n, i) {
        t.mounted[e] = n, t.listenerOpts[e] = i, te(t.domTarget, e, n, i)
    }

    function Ri(t) {
        var e, n, i, r, o = t.mounted;
        for (var a in o) o.hasOwnProperty(a) && (e = t.domTarget, n = a, i = o[a], r = t.listenerOpts[a], Zt ? e.removeEventListener(n, i, r) : e.detachEvent("on" + n, i));
        t.mounted = {}
    }
    ...
    var Ni = function (t, e) {
        ...
        function e(e, n) {
            ...
            return i.__pointerCapturing = !1, i.dom = e, i.painterRoot = n, i._localHandlerScope = new Ni(e, Di), xi && (i._globalHandlerScope = new Ni(document, Li)), ki(i, i._localHandlerScope), i
        }

        return n(e, t), e.prototype.dispose = function () {
            Ri(this._localHandlerScope), xi && Ri(this._globalHandlerScope)
        }, e.prototype.setCursor = function (t) {
            this.dom.style && (this.dom.style.cursor = t || "default")
        }, e.prototype.__togglePointerCapture = function (t) {
            if (this.__mayPointerCapture = null, xi && +this.__pointerCapturing ^ +t) {
        ...
        return n(e, t), e.prototype.childrenRef = function () {
            ...
            var e = this.__zr, n = this._children, i = A(n, t);
            ...
            for (var e = new Rn(0, 0, 0, 0), n = t || this._children, i = [], r = null, o = 0; o < n.length; o++) {
                var a = n[o];
                if (!a.ignore && !a.invisible) {
                    var s = a.getBoundingRect(), l = a.getLocalTransform(i);
                    l ? (Rn.applyTransform(e, s, l), (r = r || e.clone()).union(e)) : (r = r || s.clone()).union(s)
                }
            }
            return r || e
        }, e
    }(ei);
    zi.prototype.type = "group";
    /*!
        ...
        */
    var Bi = !a.canvasSupported, Vi = {}, Fi = {};
    var Gi = function () {
        function t(t, e, n) {
            var i = this;
            ...
            var r = new vi, o = n.renderer || "canvas";
            if (Bi) throw new Error("IE8 support has been dropped since 5.0");
            if (Vi[o] || (o = z(Vi)[0]), !Vi[o]) throw new Error("Renderer '" + o + "' is not imported. Please import it first.");
            n.useDirtyRect = null != n.useDirtyRect && n.useDirtyRect;
            var s = new Vi[o](e, r, n, t);
            this.storage = r, this.painter = s;
            var l = a.node || a.worker ? null : new Ei(s.getViewportRoot(), s.root);
            this.handler = new ce(r, s, l, s.root), this.animation = new _i({
                stage: {
                    update: function () {
                        return i._flush(!0)
                    }
        ...
        return t.prototype.add = function (t) {
            ...
            this.painter.setBackgroundColor && this.painter.setBackgroundColor(t), this.refresh(), this._backgroundColor = t, this._darkMode = function (t) {
                if (!t) return !1;
                if ("string" == typeof t) return sn(t, 1) < .4;
                if (t.colorStops) {
                    for (var e = t.colorStops, n = 0, i = e.length, r = 0; r < i; r++) n += sn(e[r].color, 1);
                    return (n /= i) < .4
                }
                return !1
            }(t)
            ...
            for (var t = this.storage.getRoots(), e = 0; e < t.length; e++) t[e] instanceof zi && t[e].removeSelfFromZr(this);
            this.storage.delAllRoots(), this.painter.clear()
        }, t.prototype.dispose = function () {
            var t;
            this.animation.stop(), this.clear(), this.storage.dispose(), this.painter.dispose(), this.handler.dispose(), this.animation = this.storage = this.painter = this.handler = null, t = this.id, delete Fi[t]
        }, t
    }();
    ...
    var Yi = Object.freeze({
        __proto__: null, init: Hi, dispose: function (t) {
            t.dispose()
        }, disposeAll: function () {
            for (var t in Fi) Fi.hasOwnProperty(t) && Fi[t].dispose();
            Fi = {}
        }, getInstance: function (t) {
            return Fi[t]
        }, registerPainter: Wi, version: "5.0.4"
    }), Xi = 1e-4;
    ...
    function Zi(t, e) {
        ...
        return "string" == typeof t ? (n = t, n.replace(/^\s+|\s+$/g, "")).match(/%$/) ? parseFloat(t) / 100 * e : parseFloat(t) : null == t ? NaN : +t;
        var n
    }
    ...
    function Qi(t, e, n) {
        if (!t[e]) return 0;
        var i = R(t, (function (t, e) {
            return t + (isNaN(e) ? 0 : e)
        }), 0);
        if (0 === i) return 0;
        for (var r = Math.pow(10, n), o = O(t, (function (t) {
            return (isNaN(t) ? 0 : t) / i * r * 100
        })), a = 100 * r, s = O(o, (function (t) {
            return Math.floor(t)
        })), l = R(s, (function (t, e) {
            return t + e
        }), 0), u = O(o, (function (t, e) {
            return t - s[e]
        })); l < a;) {
            for (var h = Number.NEGATIVE_INFINITY, c = null, p = 0, d = u.length; p < d; ++p) u[p] > h && (h = u[p], c = p);
            ++s[c], u[c] = 0, ++l
        }
        return s[e] / r
    }
    ...
    var ir = /^(?:(\d{4})(?:[-\/](\d{1,2})(?:[-\/](\d{1,2})(?:[T ](\d{1,2})(?::(\d{1,2})(?::(\d{1,2})(?:[.,](\d+))?)?)?(Z|[\+\-]\d\d:?\d\d)?)?)?)?)?$/;
    ...
    function sr(t, e) {
        var n = ar(t), i = Math.pow(10, n), r = t / i;
    ...
    function dr(t, e) {
        return 0 === e ? t : dr(e, t % e)
    }

    function fr(t, e) {
        return null == t ? e : null == e ? t : t * e / dr(t, e)
    }
    ...
    var br = ["fontStyle", "fontWeight", "fontSize", "fontFamily", "rich", "tag", "color", "textBorderColor", "textBorderWidth", "width", "height", "lineHeight", "align", "verticalAlign", "baseline", "shadowColor", "shadowBlur", "shadowOffsetX", "shadowOffsetY", "textShadowColor", "textShadowBlur", "textShadowOffsetX", "textShadowOffsetY", "backgroundColor", "borderColor", "borderWidth", "borderRadius", "padding"];

    function wr(t) {
        return !X(t) || F(t) || t instanceof Date ? t : t.value
    }
    ...
    function Sr(t, e, n) {
        ...
        var s, l, u = function (t, e, n) {
            ...
            for (var r = 0; r < t.length; r++) {
                ...
                o && null != o.id && e.set(o.id, r), i.push({
                    existing: "replaceMerge" === n || Ar(o) ? null : o,
                    newOption: null,
                    keyInfo: null,
                    brandNew: null
                })
        ...
        return (i || r) && function (t, e, n, i) {
            P(i, (function (r, o) {
                if (r && null != r.id) {
                    var a = Ir(r.id), s = n.get(a);
                    if (null != s) {
                        var l = t[s];
                        rt(!l.newOption, 'Duplicated option on id "' + a + '".'), l.newOption = r, l.existing = e[s], i[o] = null
                    }
                }
            }))
            ...
            P(e, (function (n, i) {
                if (n && null != n.name) for (var r = 0; r < t.length; r++) {
                    var o = t[r].existing;
                    if (!t[r].newOption && o && (null == o.id || null == n.id) && !Ar(n) && !Ar(o) && Mr("name", o, n)) return t[r].newOption = n, void (e[i] = null)
                }
            }))
        }(u, e), i || r ? function (t, e, n) {
            P(e, (function (e) {
                if (e) {
                    for (var i, r = 0; (i = t[r]) && (i.newOption || Ar(i.existing) || i.existing && null != e.id && !Mr("id", e, i.existing));) r++;
        ...
        }(u, e), s = u, l = ht(), P(s, (function (t) {
            var e = t.existing;
            e && l.set(e.id, t)
        })), P(s, (function (t) {
            var e = t.newOption;
            rt(!e || null == e.id || !l.get(e.id) || l.get(e.id) === t, "id duplicates: " + (e && e.id)), e && null != e.id && l.set(e.id, t), !t.keyInfo && (t.keyInfo = {})
        })), P(s, (function (t, e) {
            var n = t.existing, i = t.newOption, r = t.keyInfo;
            if (X(i)) {
                if (r.name = null != i.name ? Ir(i.name) : n ? n.name : vr + e, n) r.id = Ir(n.id); else if (null != i.id) r.id = Ir(i.id); else {
                    var o = 0;
                    do {
                        r.id = "\0" + r.name + "\0" + o++
                    } while (l.get(r.id))
    ...
    function Tr(t, e) {
        if (null == t) return e;
        var n = typeof t;
        return "string" === n ? t : "number" === n || W(t) ? t + "" : e
    }

    function Cr(t) {
        var e = t.name;
        return !(!e || !e.indexOf(vr))
    }

    function Ar(t) {
        return t && null != t.id && 0 === Ir(t.id).indexOf(mr)
    }

    function Dr(t, e) {
        return null != e.dataIndexInside ? e.dataIndexInside : null != e.dataIndex ? F(e.dataIndex) ? O(e.dataIndex, (function (e) {
            return t.indexOfRawIndex(e)
        })) : t.indexOfRawIndex(e.dataIndex) : null != e.name ? F(e.name) ? O(e.name, (function (e) {
            return t.indexOfName(e)
        })) : t.indexOfName(e.name) : void 0
    }

    function Lr() {
        var t = "__ec_inner_" + kr++;
        return function (e) {
            return e[t] || (e[t] = {})
        }
    }
    ...
    function Pr(t, e, n) {
        ...
        P(i, (function (t, e) {
            if ("dataIndex" !== e && "dataIndexInside" !== e) {
                ...
                if (r && l && !(n && n.includeMainTypes && A(n.includeMainTypes, r) < 0)) s = s || !!r, (o.get(r) || o.set(r, {}))[l] = t
            } else a[e] = t
        }));
    ...
    var Or = {useDefault: !0, enableAll: !1, enableNone: !1}, Rr = {useDefault: !1, enableAll: !0, enableNone: !0};
    ...
    function Nr(t, e, n, i) {
        ...
        return "none" === r || !1 === r ? (rt(i.enableNone, '`"none"` or `false` is not a valid value on index option.'), s.models = [], s) : ("all" === r && (rt(i.enableAll, '`"all"` is not a valid value on index option.'), r = o = a = null), s.models = t.queryComponents({
            mainType: e,
            index: r,
            id: o,
            name: a
    ...
    function Br(t, e, n, i, r) {
        var o = null == e || "auto" === e;
        if (null == i) return i;
        if ("number" == typeof i) return ji(d = hn(n || 0, i, r), o ? Math.max($i(n || 0), $i(i)) : e);
        if ("string" == typeof i) return r < 1 ? n : i;
        for (var a = [], s = n, l = i, u = Math.max(s ? s.length : 0, l.length), h = 0; h < u; ++h) {
            if ("ordinal" === t.getDimensionInfo(h).type) a[h] = (r < 1 && s ? s : l)[h]; else {
                var c = s && s[h] ? s[h] : 0, p = l[h], d = hn(c, p, r);
                a[h] = ji(d, o ? Math.max($i(c), $i(p)) : e)
            }
        }
        return a
    }

    var Vr = "___EC__COMPONENT__CONTAINER___", Fr = "___EC__EXTENDED_CLASS___";
        ...
        t.$constructor = t, t.extend = function (t) {
            ...
            function n() {
                ...
                if (t.$constructor) t.$constructor.apply(this, arguments); else {
                    if (Wr(e)) {
                        var a = pt(n.prototype, new (e.bind.apply(e, r([void 0], i))));
                        return a
                    }
            ...
            return n[Fr] = !0, I(n.prototype, t), n.extend = this.extend, n.superCall = Ur, n.superApply = Zr, D(n, this), n.superClass = e, n
        }
    }
    ...
    var Xr = Math.round(10 * Math.random());
    ...
    function jr(t) {
        ...
        t.registerClass = function (t) {
            ...
            if (i) {
                rt(/^[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)?$/.test(n = i), 'componentType "' + n + '" illegal'), t.prototype.type = i;
                var r = Gr(i);
                if (r.sub) {
                    if (r.sub !== Vr) {
                        (function (t) {
                            var n = e[t.main];
                            n && n[Vr] || ((n = e[t.main] = {})[Vr] = !0);
                            return n
                        }(r))[r.sub] = t
                    }
                } else e[r.main] = t
            ...
            var r = e[t];
            if (r && r[Vr] && (r = n ? r[n] : null), i && !r) throw new Error(n ? "Component " + t + "." + (n || "") + " not exists. Load it first." : t + ".type should be specified.");
            return r
        }, t.getClassesByMainType = function (t) {
            var n = Gr(t), i = [], r = e[n.main];
            return r && r[Vr] ? P(r, (function (t, e) {
                e !== Vr && i.push(t)
            })) : i.push(r), i
    ...
    var Kr = qr([["fill", "color"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["opacity"], ["shadowColor"]]),
        $r = function () {
            function t() {
            }
    ...
    function to(t, e, n, i, r) {
        if (t) {
            if ("string" == typeof t) {
                ...
                var o = Jr.get(t), a = {hostEl: n, cb: i, cbPayload: r};
                return o ? !no(e = o.image) && o.pending.push(a) : ((e = new Image).onload = e.onerror = eo, Jr.put(t, e.__cachedImgObj = {
                    image: e,
                    pending: [a]
    ...
    function ro(t, e, n, i, r) {
        ...
        var o = (t + "").split("\n");
        r = oo(e, n, i, r);
        for (var a = 0, s = o.length; a < s; a++) o[a] = ao(o[a], r);
        return o.join("\n")
    }

    function oo(t, e, n, i) {
        var r = I({}, i = i || {});
        r.font = e, n = tt(n, "..."), r.maxIterations = tt(i.maxIterations, 2);
        var o = r.minChar = tt(i.minChar, 0);
        r.cnCharWidth = Bn("国", e);
        var a = r.ascCharWidth = Bn("a", e);
        r.placeholder = tt(i.placeholder, "");
    ...
    function ao(t, e) {
        ...
        for (var a = 0; ; a++) {
            ...
            var s = 0 === a ? so(t, r, e.ascCharWidth, e.cnCharWidth) : o > 0 ? Math.floor(t.length * r / o) : 0;
            o = Bn(t = t.substr(0, s), i)
        }
    ...
    function co(t, e, n, i, r) {
        ...
        if (i) {
            ...
            if (null != l.width && "auto" !== l.width) {
                var f = function (t, e) {
                    if ("string" == typeof t) return t.lastIndexOf("%") >= 0 ? parseFloat(t) / 100 * e : parseFloat(t);
                    return t
                }(l.width, i.width) + d;
                u.length > 0 && f + i.accumWidth > i.width && (o = e.split("\n"), c = !0), i.accumWidth = f
            } else {
                var g = go(e, h, i.width, i.breakAll, i.accumWidth);
                i.accumWidth = g.accumWidth + d, a = g.linesWidths, o = g.lines
            }
        } else o = e.split("\n");
        for (var y = 0; y < o.length; y++) {
            var v = o[y], m = new lo;
            if (m.styleName = r, m.text = v, m.isLineHolder = !v && !s, "number" == typeof l.width ? m.width = l.width : m.width = a ? a[y] : Bn(v, h), y || c) u.push(new uo([m])); else {
                var _ = (u[u.length - 1] || (u[0] = new uo)).tokens, x = _.length;
                1 === x && _[0].isLineHolder ? _[0] = m : (v || !x || s) && _.push(m)
            }
        }
    }

    var po = R(",&?/;] ".split(""), (function (t, e) {
        return t[e] = !0, t
    }), {});
    ...
    function go(t, e, n, i, r) {
        for (var o = [], a = [], s = "", l = "", u = 0, h = 0, c = 0; c < t.length; c++) {
            var p = t.charAt(c);
            if ("\n" !== p) {
                var d = Bn(p, e), f = !i && !fo(p);
                (o.length ? h + d > n : r + h + d > n) ? h ? (s || l) && (f ? (s || (s = l, l = "", h = u = 0), o.push(s), a.push(h - u), l += p, s = "", h = u += d) : (l && (s += l, h += u, l = "", u = 0), o.push(s), a.push(h), s = p, h = d)) : f ? (o.push(l), a.push(u), l = p, u = d) : (o.push(p), a.push(d)) : (h += d, f ? (l += p, u += d) : (l && (s += l, l = "", u = 0), s += p))
    ...
    var yo = "__zr_style_" + Math.round(10 * Math.random()),
        vo = {shadowBlur: 0, shadowOffsetX: 0, shadowOffsetY: 0, shadowColor: "#000", opacity: 1, blend: "source-over"},
        mo = {style: {shadowBlur: !0, shadowOffsetX: !0, shadowOffsetY: !0, shadowColor: !0, opacity: !0}};
    vo[yo] = !0;
    var _o = ["z", "z2", "invisible"], xo = function (t) {
        function e(e) {
        ...
        return n(e, t), e.prototype._init = function (e) {
            ...
            if (this.ignore || this.invisible || 0 === this.style.opacity || this.culling && function (t, e, n) {
                bo.copy(t.getBoundingRect()), t.transform && bo.applyTransform(t.transform);
                return wo.width = e, wo.height = n, !bo.intersect(wo)
            ...
            if (!this._paintRect || this.__dirty) {
                ...
                t = this._paintRect || (this._paintRect = new Rn(0, 0, 0, 0)), e ? Rn.applyTransform(t, n, e) : t.copy(n), (r || o || a) && (t.width += 2 * r + Math.abs(o), t.height += 2 * r + Math.abs(a), t.x = Math.min(t.x, t.x + o - r), t.y = Math.min(t.y, t.y + a - r));
            ...
            t ? (this._prevPaintRect = this._prevPaintRect || new Rn(0, 0, 0, 0), this._prevPaintRect.copy(t)) : this._prevPaintRect = null
        ...
        }, e.prototype.dirtyStyle = function () {
            this.markRedraw(), this.__dirty |= e.STYLE_CHANGED_BIT, this._rect && (this._rect = null)
        }, e.prototype.dirty = function () {
            this.dirtyStyle()
        }, e.prototype.styleChanged = function () {
            return !!(this.__dirty & e.STYLE_CHANGED_BIT)
        }, e.prototype.styleUpdated = function () {
            this.__dirty &= ~e.STYLE_CHANGED_BIT
        }, e.prototype.createStyle = function (t) {
            return pt(vo, t)
        }, e.prototype.useStyle = function (t) {
            t[yo] || (t = this.createStyle(t)), this.__inHover ? this.__hoverStyle = t : this.style = t, this.dirtyStyle()
            ...
            e.style && !n.style && (n.style = this._mergeStyle(this.createStyle(), this.style)), this._savePrimaryToNormal(e, n, _o)
            ...
            if (n && n.style ? o ? r ? s = n.style : (s = this._mergeStyle(this.createStyle(), i.style), this._mergeStyle(s, n.style)) : (s = this._mergeStyle(this.createStyle(), r ? this.style : i.style), this._mergeStyle(s, n.style)) : l && (s = i.style), s) if (o) {
                var u = this.style;
                if (this.style = this.createStyle(l ? {} : u), l) for (var h = z(u), c = 0; c < h.length; c++) {
            ...
            return mo
        }, e.STYLE_CHANGED_BIT = 2, e.initDefaultProps = ((i = e.prototype).type = "displayable", i.invisible = !1, i.z = 0, i.z2 = 0, i.zlevel = 0, i.culling = !1, i.cursor = "pointer", i.rectHover = !1, i.incremental = !1, i._rect = null, i.dirtyRectTolerance = 0, void (i.__dirty = ei.REDARAW_BIT | e.STYLE_CHANGED_BIT)), e
    }(ei), bo = new Rn(0, 0, 0, 0), wo = new Rn(0, 0, 0, 0);
    var So = Math.pow, Mo = Math.sqrt, Io = 1e-8, To = 1e-4, Co = Mo(3), Ao = 1 / 3, Do = yt(), Lo = yt(), ko = yt();
    ...
    function Eo(t, e, n, i, r, o) {
        ...
        if (Po(h) && Po(c)) {
            if (Po(s)) o[0] = 0; else (M = -l / s) >= 0 && M <= 1 && (o[d++] = M)
        } else {
            var f = c * c - 4 * h * p;
            if (Po(f)) {
                var g = c / h, y = -g / 2;
                ...
                var v = Mo(f), m = h * s + 1.5 * a * (-c + v), _ = h * s + 1.5 * a * (-c - v);
                (M = (-s - ((m = m < 0 ? -So(-m, Ao) : So(m, Ao)) + (_ = _ < 0 ? -So(-_, Ao) : So(_, Ao)))) / (3 * a)) >= 0 && M <= 1 && (o[d++] = M)
            } else {
                var x = (2 * h * s - 3 * a * c) / (2 * Mo(h * h * h)), b = Math.acos(x) / 3, w = Mo(h), S = Math.cos(b),
                    M = (-s - 2 * w * S) / (3 * a),
                    I = (y = (-s + w * (S + Co * Math.sin(b))) / (3 * a), (-s + w * (S - Co * Math.sin(b))) / (3 * a));
    ...
    function zo(t, e, n, i, r) {
        ...
        if (Po(a)) {
            if (Oo(o)) (h = -s / o) >= 0 && h <= 1 && (r[l++] = h)
        } else {
            var u = o * o - 4 * a * s;
            if (Po(u)) r[0] = -o / (2 * a); else if (u > 0) {
                var h, c = Mo(u), p = (-o - c) / (2 * a);
    ...
    function Vo(t, e, n, i, r, o, a, s, l, u, h) {
        ...
        Do[0] = l, Do[1] = u;
        for (var m = 0; m < 1; m += .05) Lo[0] = Ro(t, n, r, a, m), Lo[1] = Ro(e, i, o, s, m), (f = Pt(Do, Lo)) < v && (c = m, v = f);
        v = 1 / 0;
        for (var _ = 0; _ < 32 && !(y < To); _++) p = c - y, d = c + y, Lo[0] = Ro(t, n, r, a, p), Lo[1] = Ro(e, i, o, s, p), f = Pt(Lo, Do), p >= 0 && f < v ? (c = p, v = f) : (ko[0] = Ro(t, n, r, a, d), ko[1] = Ro(e, i, o, s, d), g = Pt(ko, Do), d <= 1 && g < v ? (c = d, v = g) : y *= .5);
        return h && (h[0] = Ro(t, n, r, a, c), h[1] = Ro(e, i, o, s, c)), Mo(v)
    }

    function Fo(t, e, n, i, r, o, a, s, l) {
        for (var u = t, h = e, c = 0, p = 1 / l, d = 1; d <= l; d++) {
            var f = d * p, g = Ro(t, n, r, a, f), y = Ro(e, i, o, s, f), v = g - u, m = y - h;
    ...
    function Xo(t, e, n, i, r, o, a, s, l) {
        ...
        for (var p = 0; p < 1; p += .05) {
            Lo[0] = Go(t, n, r, p), Lo[1] = Go(e, i, o, p), (y = Pt(Do, Lo)) < c && (u = p, c = y)
        }
        c = 1 / 0;
        for (var d = 0; d < 32 && !(h < To); d++) {
            var f = u - h, g = u + h;
            Lo[0] = Go(t, n, r, f), Lo[1] = Go(e, i, o, f);
            var y = Pt(Lo, Do);
            if (f >= 0 && y < c) u = f, c = y; else {
                ko[0] = Go(t, n, r, g), ko[1] = Go(e, i, o, g);
                var v = Pt(ko, Do);
                g <= 1 && v < c ? (u = g, c = v) : h *= .5
            }
        }
        return l && (l[0] = Go(t, n, r, u), l[1] = Go(e, i, o, u)), Mo(c)
    }

    function Uo(t, e, n, i, r, o, a) {
        for (var s = t, l = e, u = 0, h = 1 / a, c = 1; c <= a; c++) {
            var p = c * h, d = Go(t, n, r, p), f = Go(e, i, o, p), g = d - s, y = f - l;
            u += Math.sqrt(g * g + y * y), s = d, l = f
        }
        return u
    }

    var Zo = Math.min, jo = Math.max, qo = Math.sin, Ko = Math.cos, $o = 2 * Math.PI, Jo = yt(), Qo = yt(), ta = yt();

    function ea(t, e, n) {
        if (0 !== t.length) {
            for (var i = t[0], r = i[0], o = i[0], a = i[1], s = i[1], l = 1; l < t.length; l++) i = t[l], r = Zo(r, i[0]), o = jo(o, i[0]), a = Zo(a, i[1]), s = jo(s, i[1]);
            e[0] = r, e[1] = a, n[0] = o, n[1] = s
        }
    }

    function na(t, e, n, i, r, o) {
        r[0] = Zo(t, n), r[1] = Zo(e, i), o[0] = jo(t, n), o[1] = jo(e, i)
    }

    var ia = [], ra = [];

    function oa(t, e, n, i, r, o, a, s, l, u) {
        var h = zo, c = Ro, p = h(t, n, r, a, ia);
        l[0] = 1 / 0, l[1] = 1 / 0, u[0] = -1 / 0, u[1] = -1 / 0;
        for (var d = 0; d < p; d++) {
            var f = c(t, n, r, a, ia[d]);
            l[0] = Zo(f, l[0]), u[0] = jo(f, u[0])
        }
        p = h(e, i, o, s, ra);
        for (d = 0; d < p; d++) {
            var g = c(e, i, o, s, ra[d]);
            l[1] = Zo(g, l[1]), u[1] = jo(g, u[1])
        }
        l[0] = Zo(t, l[0]), u[0] = jo(t, u[0]), l[0] = Zo(a, l[0]), u[0] = jo(a, u[0]), l[1] = Zo(e, l[1]), u[1] = jo(e, u[1]), l[1] = Zo(s, l[1]), u[1] = jo(s, u[1])
    }

    function aa(t, e, n, i, r, o, a, s) {
        var l = Wo, u = Go, h = jo(Zo(l(t, n, r), 1), 0), c = jo(Zo(l(e, i, o), 1), 0), p = u(t, n, r, h),
            d = u(e, i, o, c);
        a[0] = Zo(t, r, p), a[1] = Zo(e, o, d), s[0] = jo(t, r, p), s[1] = jo(e, o, d)
    }

    function sa(t, e, n, i, r, o, a, s, l) {
        var u = Nt, h = Et, c = Math.abs(r - o);
        if (c % $o < 1e-4 && c > 1e-4) return s[0] = t - n, s[1] = e - i, l[0] = t + n, void (l[1] = e + i);
        if (Jo[0] = Ko(r) * n + t, Jo[1] = qo(r) * i + e, Qo[0] = Ko(o) * n + t, Qo[1] = qo(o) * i + e, u(s, Jo, Qo), h(l, Jo, Qo), (r %= $o) < 0 && (r += $o), (o %= $o) < 0 && (o += $o), r > o && !a ? o += $o : r < o && a && (r += $o), a) {
            var p = o;
            o = r, r = p
        }
        for (var d = 0; d < o; d += Math.PI / 2) d > r && (ta[0] = Ko(d) * n + t, ta[1] = qo(d) * i + e, u(s, ta, s), h(l, ta, l))
    }

    var la = {M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7}, ua = [], ha = [], ca = [], pa = [], da = [], fa = [],
        ga = Math.min, ya = Math.max, va = Math.cos, ma = Math.sin, _a = Math.sqrt, xa = Math.abs, ba = Math.PI,
        wa = 2 * ba, Sa = "undefined" != typeof Float32Array, Ma = [];

    function Ia(t) {
        return Math.round(t / ba * 1e8) / 1e8 % 2 * ba
    }
    ...
    function Ta(t, e) {
        ...
        n < 0 && (n += wa);
        var i = n - t[0], r = t[1];
        r += i, !e && r - n >= wa ? r = n + wa : e && n - r >= wa ? r = n - wa : !e && n > r ? r = n + (wa - Ia(n - r)) : e && n < r && (r = n - (wa - Ia(r - n))), t[0] = n, t[1] = r
    }
    ...
    var Ca = function () {
        ...
        return t.prototype.increaseVersion = function () {
            ...
            (n = n || 0) > 0 && (this._ux = xa(n / Zn / t) || 0, this._uy = xa(n / Zn / e) || 0)
            ...
            var n = xa(t - this._xi) > this._ux || xa(e - this._yi) > this._uy || this._len < 5;
            ...
            return this.addData(la.C, t, e, n, i, r, o), this._ctx && (this._needsDash ? this._dashedBezierTo(t, e, n, i, r, o) : this._ctx.bezierCurveTo(t, e, n, i, r, o)), this._xi = r, this._yi = o, this
            ...
            Ma[0] = i, Ma[1] = r, Ta(Ma, o), i = Ma[0];
            var a = (r = Ma[1]) - i;
            return this.addData(la.A, t, e, n, n, i, a, 0, o ? 0 : 1), this._ctx && this._ctx.arc(t, e, n, i, r, o), this._xi = va(r) * n + t, this._yi = ma(r) * n + e, this
            ...
            var e = t.length;
            this.data && this.data.length === e || !Sa || (this.data = new Float32Array(e));
            ...
            Sa && this.data instanceof Float32Array && (this.data = new Float32Array(i + n));
            ...
            var n, i, r = this._dashSum, o = this._lineDash, a = this._ctx, s = this._dashOffset, l = this._xi,
                u = this._yi, h = t - l, c = e - u, p = _a(h * h + c * c), d = l, f = u, g = o.length;
            for (s < 0 && (s = r + s), d -= (s %= r) * (h /= p), f -= s * (c /= p); h > 0 && d <= t || h < 0 && d >= t || 0 === h && (c > 0 && f <= e || c < 0 && f >= e);) d += h * (n = o[i = this._dashIdx]), f += c * n, this._dashIdx = (i + 1) % g, h > 0 && d < l || h < 0 && d > l || c > 0 && f < u || c < 0 && f > u || a[i % 2 ? "moveTo" : "lineTo"](h >= 0 ? ga(d, t) : ya(d, t), c >= 0 ? ga(f, e) : ya(f, e));
            h = d - t, c = f - e, this._dashOffset = -_a(h * h + c * c)
            ...
            for (d < 0 && (d = p + d), d %= p, a = 0; a < 1; a += .1) s = Ro(g, t, n, r, a + .1) - Ro(g, t, n, r, a), l = Ro(y, e, i, o, a + .1) - Ro(y, e, i, o, a), v += _a(s * s + l * l);
            for (; m < _ && !((x += f[m]) > d); m++) ;
            for (a = (x - d) / v; a <= 1;) u = Ro(g, t, n, r, a), h = Ro(y, e, i, o, a), m % 2 ? c.moveTo(u, h) : c.lineTo(u, h), a += f[m] / v, m = (m + 1) % _;
            m % 2 != 0 && c.lineTo(r, o), s = r - u, l = o - h, this._dashOffset = -_a(s * s + l * l)
            ...
            if (this._saveData) {
                var t = this.data;
                t instanceof Array && (t.length = this._len, Sa && this._len > 11 && (this.data = new Float32Array(t)))
            }
        }, t.prototype.getBoundingRect = function () {
            ca[0] = ca[1] = da[0] = da[1] = Number.MAX_VALUE, pa[0] = pa[1] = fa[0] = fa[1] = -Number.MAX_VALUE;
            var t, e = this.data, n = 0, i = 0, r = 0, o = 0;
            for (t = 0; t < this._len;) {
                var a = e[t++], s = 1 === t;
                switch (s && (r = n = e[t], o = i = e[t + 1]), a) {
                    case la.M:
                        n = r = e[t++], i = o = e[t++], da[0] = r, da[1] = o, fa[0] = r, fa[1] = o;
                        break;
                    case la.L:
                        na(n, i, e[t], e[t + 1], da, fa), n = e[t++], i = e[t++];
                        break;
                    case la.C:
                        oa(n, i, e[t++], e[t++], e[t++], e[t++], e[t], e[t + 1], da, fa), n = e[t++], i = e[t++];
                        break;
                    case la.Q:
                        aa(n, i, e[t++], e[t++], e[t], e[t + 1], da, fa), n = e[t++], i = e[t++];
                        break;
                    case la.A:
                        var l = e[t++], u = e[t++], h = e[t++], c = e[t++], p = e[t++], d = e[t++] + p;
                        t += 1;
                        var f = !e[t++];
                        s && (r = va(p) * h + l, o = ma(p) * c + u), sa(l, u, h, c, p, d, f, da, fa), n = va(d) * h + l, i = ma(d) * c + u;
                        break;
                    case la.R:
                        na(r = n = e[t++], o = i = e[t++], r + e[t++], o + e[t++], da, fa);
                        break;
                    case la.Z:
                        n = r, i = o
                }
                Nt(ca, ca, da), Et(pa, pa, fa)
            }
            return 0 === t && (ca[0] = ca[1] = pa[0] = pa[1] = 0), new Rn(ca[0], ca[1], pa[0] - ca[0], pa[1] - ca[1])
            ...
            for (var l = this._pathSegLen, u = 0, h = 0, c = 0; c < e;) {
                ...
                switch (p) {
                    ...
                    case la.L:
                        var g = t[c++], y = (_ = t[c++]) - o;
                        (xa(D = g - r) > n || xa(y) > i || c === e - 1) && (f = Math.sqrt(D * D + y * y), r = g, o = _);
                        break;
                    case la.C:
                        var v = t[c++], m = t[c++], _ = (g = t[c++], t[c++]), x = t[c++], b = t[c++];
                        f = Fo(r, o, v, m, g, _, x, b, 10), r = x, o = b;
                        break;
                    case la.Q:
                        f = Uo(r, o, v = t[c++], m = t[c++], g = t[c++], _ = t[c++], 10), r = g, o = _;
                        break;
                    case la.A:
                        var w = t[c++], S = t[c++], M = t[c++], I = t[c++], T = t[c++], C = t[c++], A = C + T;
                        c += 1;
                        t[c++];
                        d && (a = va(T) * M + w, s = ma(T) * I + S), f = ya(M, I) * ga(wa, Math.abs(C)), r = va(A) * M + w, o = ma(A) * I + S;
                        break;
                    case la.R:
            ...
            var n, i, r, o, a, s, l, u, h = this.data, c = this._ux, p = this._uy, d = this._len, f = e < 1, g = 0,
                y = 0;
            if (!f || (this._pathSegLen || this._calculateLength(), l = this._pathSegLen, u = e * this._pathLen)) t:for (var v = 0; v < d;) {
                var m = h[v++], _ = 1 === v;
                switch (_ && (n = r = h[v], i = o = h[v + 1]), m) {
                    case la.M:
                        n = r = h[v++], i = o = h[v++], t.moveTo(r, o);
                        break;
                    case la.L:
                        if (a = h[v++], s = h[v++], xa(a - r) > c || xa(s - o) > p || v === d - 1) {
                            if (f) {
                                if (g + (H = l[y++]) > u) {
                                    var x = (u - g) / H;
                                    t.lineTo(r * (1 - x) + a * x, o * (1 - x) + s * x);
                                    break t
                                }
                                g += H
                            }
                        ...
                        break;
                    case la.C:
                        var b = h[v++], w = h[v++], S = h[v++], M = h[v++], I = h[v++], T = h[v++];
                        if (f) {
                            if (g + (H = l[y++]) > u) {
                                Bo(r, b, S, I, x = (u - g) / H, ua), Bo(o, w, M, T, x, ha), t.bezierCurveTo(ua[1], ha[1], ua[2], ha[2], ua[3], ha[3]);
                                break t
                            }
                            g += H
                        }
                        t.bezierCurveTo(b, w, S, M, I, T), r = I, o = T;
                        break;
                    case la.Q:
                        b = h[v++], w = h[v++], S = h[v++], M = h[v++];
                        if (f) {
                            if (g + (H = l[y++]) > u) {
                                Yo(r, b, S, x = (u - g) / H, ua), Yo(o, w, M, x, ha), t.quadraticCurveTo(ua[1], ha[1], ua[2], ha[2]);
                                break t
                            }
                            g += H
                        }
                        t.quadraticCurveTo(b, w, S, M), r = S, o = M;
                        break;
                    case la.A:
                        var C = h[v++], A = h[v++], D = h[v++], L = h[v++], k = h[v++], P = h[v++], O = h[v++],
                            R = !h[v++], N = D > L ? D : L, E = xa(D - L) > .001, z = k + P, B = !1;
                        if (f) g + (H = l[y++]) > u && (z = k + P * (u - g) / H, B = !0), g += H;
                        if (E && t.ellipse ? t.ellipse(C, A, D, L, O, k, z, R) : t.arc(C, A, N, k, z, R), B) break t;
                        _ && (n = va(k) * D + C, i = ma(k) * L + A), r = va(z) * D + C, o = ma(z) * L + A;
                        break;
                    case la.R:
                        n = r = h[v], i = o = h[v + 1], a = h[v++], s = h[v++];
                        var V = h[v++], F = h[v++];
                        if (f) {
                            if (g + (H = l[y++]) > u) {
                                var G = u - g;
                                t.moveTo(a, s), t.lineTo(a + ga(G, V), s), (G -= V) > 0 && t.lineTo(a + V, s + ga(G, F)), (G -= F) > 0 && t.lineTo(a + ya(V - G, 0), s + F), (G -= V) > 0 && t.lineTo(a, s + ya(F - G, 0));
                                break t
                            }
                            g += H
                        }
        ...
        }, t.CMD = la, t.initDefaultProps = function () {
            var e = t.prototype;
    ...
    function Da(t, e, n, i, r, o, a, s, l, u, h) {
        if (0 === l) return !1;
        var c = l;
        return !(h > e + c && h > i + c && h > o + c && h > s + c || h < e - c && h < i - c && h < o - c && h < s - c || u > t + c && u > n + c && u > r + c && u > a + c || u < t - c && u < n - c && u < r - c && u < a - c) && Vo(t, e, n, i, r, o, a, s, u, h, null) <= c / 2
    }

    function La(t, e, n, i, r, o, a, s, l) {
        if (0 === a) return !1;
        var u = a;
        return !(l > e + u && l > i + u && l > o + u || l < e - u && l < i - u && l < o - u || s > t + u && s > n + u && s > r + u || s < t - u && s < n - u && s < r - u) && Xo(t, e, n, i, r, o, s, l, null) <= u / 2
    }

    var ka = 2 * Math.PI;

    function Pa(t) {
        return (t %= ka) < 0 && (t += ka), t
    }

    var Oa = 2 * Math.PI;

    function Ra(t, e, n, i, r, o, a, s, l) {
        if (0 === a) return !1;
        var u = a;
        s -= t, l -= e;
        var h = Math.sqrt(s * s + l * l);
        if (h - u > n || h + u < n) return !1;
        if (Math.abs(i - r) % Oa < 1e-4) return !0;
        if (o) {
            var c = i;
            i = Pa(r), r = Pa(c)
        } else i = Pa(i), r = Pa(r);
        ...
        return p < 0 && (p += Oa), p >= i && p <= r || p + Oa >= i && p + Oa <= r
    }
    ...
    var Ea = Ca.CMD, za = 2 * Math.PI;
    var Ba = [-1, -1, -1], Va = [-1, -1];

    function Fa(t, e, n, i, r, o, a, s, l, u) {
        if (u > e && u > i && u > o && u > s || u < e && u < i && u < o && u < s) return 0;
        var h, c = Eo(e, i, o, s, u, Ba);
        if (0 === c) return 0;
        for (var p = 0, d = -1, f = void 0, g = void 0, y = 0; y < c; y++) {
            var v = Ba[y], m = 0 === v || 1 === v ? .5 : 1;
            Ro(t, n, r, a, v) < l || (d < 0 && (d = zo(e, i, o, s, Va), Va[1] < Va[0] && d > 1 && (h = void 0, h = Va[0], Va[0] = Va[1], Va[1] = h), f = Ro(e, i, o, s, Va[0]), d > 1 && (g = Ro(e, i, o, s, Va[1]))), 2 === d ? v < Va[0] ? p += f < e ? m : -m : v < Va[1] ? p += g < f ? m : -m : p += s < g ? m : -m : v < Va[0] ? p += f < e ? m : -m : p += s < f ? m : -m)
        }
        return p
    }
    ...
    function Ga(t, e, n, i, r, o, a, s) {
        ...
        var l = function (t, e, n, i, r) {
            ...
            if (Po(o)) Oo(a) && (h = -s / a) >= 0 && h <= 1 && (r[l++] = h); else {
                var u = a * a - 4 * o * s;
                if (Po(u)) (h = -a / (2 * o)) >= 0 && h <= 1 && (r[l++] = h); else if (u > 0) {
                    var h, c = Mo(u), p = (-a - c) / (2 * o);
        ...
        var u = Wo(e, i, o);
        if (u >= 0 && u <= 1) {
            for (var h = 0, c = Go(e, i, o, u), p = 0; p < l; p++) {
                var d = 0 === Ba[p] || 1 === Ba[p] ? .5 : 1;
                Go(t, n, r, Ba[p]) < a || (Ba[p] < u ? h += c < e ? d : -d : h += o < c ? d : -d)
            }
            return h
        }
        d = 0 === Ba[0] || 1 === Ba[0] ? .5 : 1;
        return Go(t, n, r, Ba[0]) < a ? 0 : o < e ? d : -d
    }
    ...
    function Ha(t, e, n, i, r, o, a, s) {
        ...
        for (var p = 0, d = 0; d < 2; d++) {
            ...
            if (f + t > a) {
                ...
                h = o ? 1 : -1;
                g < 0 && (g = za + g), (g >= i && g <= r || g + za >= i && g + za <= r) && (g > Math.PI / 2 && g < 1.5 * Math.PI && (h = -h), p += h)
            }
        }
        return p
    }
    ...
    function Wa(t, e, n, i, r) {
        for (var o, a, s, l, u = t.data, h = t.len(), c = 0, p = 0, d = 0, f = 0, g = 0, y = 0; y < h;) {
            var v = u[y++], m = 1 === y;
            switch (v === Ea.M && y > 1 && (n || (c += Na(p, d, f, g, i, r))), m && (f = p = u[y], g = d = u[y + 1]), v) {
                case Ea.M:
                    p = f = u[y++], d = g = u[y++];
                    break;
                case Ea.L:
                    if (n) {
                        if (Aa(p, d, u[y], u[y + 1], e, i, r)) return !0
                    } else c += Na(p, d, u[y], u[y + 1], i, r) || 0;
                    p = u[y++], d = u[y++];
                    break;
                case Ea.C:
                    if (n) {
                        if (Da(p, d, u[y++], u[y++], u[y++], u[y++], u[y], u[y + 1], e, i, r)) return !0
                    } else c += Fa(p, d, u[y++], u[y++], u[y++], u[y++], u[y], u[y + 1], i, r) || 0;
                    p = u[y++], d = u[y++];
                    break;
                case Ea.Q:
                    if (n) {
                        if (La(p, d, u[y++], u[y++], u[y], u[y + 1], e, i, r)) return !0
                    } else c += Ga(p, d, u[y++], u[y++], u[y], u[y + 1], i, r) || 0;
                    p = u[y++], d = u[y++];
                    break;
                case Ea.A:
                    var _ = u[y++], x = u[y++], b = u[y++], w = u[y++], S = u[y++], M = u[y++];
                    y += 1;
                    var I = !!(1 - u[y++]);
                    o = Math.cos(S) * b + _, a = Math.sin(S) * w + x, m ? (f = o, g = a) : c += Na(p, d, o, a, i, r);
                    var T = (i - _) * w / b + _;
                    if (n) {
                        if (Ra(_, x, w, S, S + M, I, e, T, r)) return !0
                    } else c += Ha(_, x, w, S, S + M, I, T, r);
                    p = Math.cos(S + M) * b + _, d = Math.sin(S + M) * w + x;
                    break;
                case Ea.R:
                    if (f = p = u[y++], g = d = u[y++], o = f + u[y++], a = g + u[y++], n) {
                        if (Aa(f, g, o, g, e, i, r) || Aa(o, g, o, a, e, i, r) || Aa(o, a, f, a, e, i, r) || Aa(f, a, f, g, e, i, r)) return !0
                    } else c += Na(o, g, o, a, i, r), c += Na(f, a, f, g, i, r);
                    break;
                case Ea.Z:
                    if (n) {
                        if (Aa(p, d, f, g, e, i, r)) return !0
                    } else c += Na(p, d, f, g, i, r);
                    p = f, d = g
            }
        }
        return n || (s = d, l = g, Math.abs(s - l) < 1e-4) || (c += Na(p, d, f, g, i, r) || 0), 0 !== c
    }
    ...
    var Ya = T({
        ...
        Ua = ["x", "y", "rotation", "scaleX", "scaleY", "originX", "originY", "invisible", "culling", "z", "z2", "zlevel", "parent"],
        Za = function (t) {
            function e(e) {
                return t.call(this, e) || this
            }
            ...
            return n(e, t), e.prototype.update = function () {
                ...
                if (i.decal) {
                    ...
                    for (var s = 0; s < Ua.length; ++s) r[Ua[s]] = this[Ua[s]];
                    r.__dirty |= ei.REDARAW_BIT
                ...
                for (var r = 0; r < n.length; r++) {
                    var o = n[r], a = e[o];
                    "style" === o ? this.style ? I(this.style, a) : this.useStyle(a) : "shape" === o ? I(this.shape, a) : t.prototype.attrKV.call(this, o, a)
                }
                this.style || this.useStyle({})
                ...
                if (i) {
                    ...
                    var o = this.path;
                    (r || this.__dirty & e.SHAPE_CHANGED_BIT) && (o.beginPath(), this.buildPath(o, this.shape, !1), this.pathUpdated()), t = o.getBoundingRect()
                }
                if (this._rect = t, this.hasStroke() && this.path && this.path.len() > 0) {
                    var a = this._rectWithStroke || (this._rectWithStroke = t.clone());
                    if (this.__dirty || i) {
                        a.copy(t);
                        var s = n.strokeNoScale ? this.getLineScale() : 1, l = n.lineWidth;
                        if (!this.hasFill()) {
                ...
                this.__dirty |= e.SHAPE_CHANGED_BIT, this._rect && (this._rect = null), this._decalEl && this._decalEl.dirtyShape(), this.markRedraw()
            }, e.prototype.dirty = function () {
                ...
                var n = this.shape;
                return n || (n = this.shape = {}), "string" == typeof t ? n[t] = e : I(n, t), this.dirtyShape(), this
            }, e.prototype.shapeChanged = function () {
                return !!(this.__dirty & e.SHAPE_CHANGED_BIT)
            }, e.prototype.createStyle = function (t) {
                return pt(Ya, t)
            }, e.prototype._innerSaveToNormal = function (e) {
                t.prototype._innerSaveToNormal.call(this, e);
                var n = this._normalState;
                e.shape && !n.shape && (n.shape = I({}, this.shape))
            }, e.prototype._applyStateObj = function (e, n, i, r, o, a) {
                t.prototype._applyStateObj.call(this, e, n, i, r, o, a);
                var s, l = !(n && r);
                if (n && n.shape ? o ? r ? s = n.shape : (s = I({}, i.shape), I(s, n.shape)) : (s = I({}, r ? this.shape : i.shape), I(s, n.shape)) : l && (s = i.shape), s) if (o) {
                ...
                return i
            }, e.SHAPE_CHANGED_BIT = 4, e.initDefaultProps = ((i = e.prototype).type = "path", i.strokeContainThreshold = 5, i.segmentIgnoreThreshold = 0, i.subPixelOptimize = !1, i.autoBatch = !1, void (i.__dirty = ei.REDARAW_BIT | xo.STYLE_CHANGED_BIT | e.SHAPE_CHANGED_BIT)), e
        }(xo),
        ja = T({strokeFirst: !0, font: En, x: 0, y: 0, textAlign: "left", textBaseline: "top", miterLimit: 2}, Ya),
        qa = function (t) {
            function e() {
            ...
            return n(e, t), e.prototype.hasStroke = function () {
                ...
                if (!this._rect) {
                    var e = t.text;
                    null != e ? e += "" : e = "";
                    var n = Fn(e, t.font, t.textAlign, t.textBaseline);
    ...
    qa.prototype.type = "tspan";
    var Ka = T({x: 0, y: 0}, vo),
        $a = {style: T({x: !0, y: !0, width: !0, height: !0, sx: !0, sy: !0, sWidth: !0, sHeight: !0}, mo.style)};
    var Ja = function (t) {
        function e() {
            return null !== t && t.apply(this, arguments) || this
        }
        ...
        return n(e, t), e.prototype.createStyle = function (t) {
            ...
            var t = this.style;
            return this._rect || (this._rect = new Rn(t.x || 0, t.y || 0, this.getWidth(), this.getHeight())), this._rect
        }, e
    }(xo);
    Ja.prototype.type = "image";
    var Qa = Math.round;
    ...
    function ts(t, e, n) {
        if (e) {
            ...
            var s = n && n.lineWidth;
            return s ? (Qa(2 * i) === Qa(2 * r) && (t.x1 = t.x2 = ns(i, s, !0)), Qa(2 * o) === Qa(2 * a) && (t.y1 = t.y2 = ns(o, s, !0)), t) : t
        }
    }
    ...
    function es(t, e, n) {
        if (e) {
            ...
            var s = n && n.lineWidth;
            return s ? (t.x = ns(i, s, !0), t.y = ns(r, s, !0), t.width = Math.max(ns(i + o, s, !1) - t.x, 0 === o ? 0 : 1), t.height = Math.max(ns(r + a, s, !1) - t.y, 0 === a ? 0 : 1), t) : t
        }
    }
    ...
    var as = {fill: "#000"}, ss = {
        ...
        function e(e) {
            var n = t.call(this) || this;
            return n.type = "text", n._children = [], n._defaultStyle = as, n.attr(e), n
        }
        ...
        return n(e, t), e.prototype.childrenRef = function () {
            ...
            if (i) {
                i.updateTransform();
                var r = i.transform;
                r ? (this.transform = this.transform || [], ye(this.transform, r)) : this.transform = null
            ...
            var t;
            this._childCursor = 0, cs(t = this.style), P(t.rich, cs), this.style.rich ? this._updateRichTexts() : this._updatePlainTexts(), this._children.length = this._childCursor, this.styleUpdated()
        }, e.prototype.addSelfToZr = function (e) {
            t.prototype.addSelfToZr.call(this, e);
            ...
            if (this.styleChanged() && this._updateSubTexts(), !this._rect) {
                for (var t = new Rn(0, 0, 0, 0), e = this._children, n = [], i = null, r = 0; r < e.length; r++) {
            ...
            return I(t, e), n && i ? (this._mergeRich(i, n), t.rich = i) : i && (t.rich = i), t
            ...
            var t = this.style, e = t.font || En, n = t.padding, i = function (t, e) {
                    null != t && (t += "");
                    var n, i = e.overflow, r = e.padding, o = e.font, a = "truncate" === i, s = Wn(o),
                        l = tt(e.lineHeight, s), u = "truncate" === e.lineOverflow, h = e.width,
                        c = (n = null != h && "break" === i || "breakAll" === i ? t ? go(t, e.font, h, "breakAll" === i, 0).lines : [] : t ? t.split("\n") : []).length * l,
                        p = tt(e.height, c);
                    if (c > p && u) {
                    ...
                    var f = p, g = h;
                    if (r && (f += r[0] + r[2], null != g && (g += r[1] + r[3])), t && a && null != g) for (var y = oo(h, o, e.ellipsis, {
                        minChar: e.truncateMinChar,
                        placeholder: e.placeholder
                    }), v = 0; v < n.length; v++) n[v] = ao(n[v], y);
                    if (null == h) {
                        var m = 0;
                        for (v = 0; v < n.length; v++) m = Math.max(Bn(n[v], o), m);
                        h = m
                    }
                    return {
                        lines: n,
                ...
                }(fs(t), t), r = gs(t), o = !!t.backgroundColor, a = i.outerHeight, s = i.lines, l = i.lineHeight,
                u = this._defaultStyle, h = t.x || 0, c = t.y || 0, p = t.align || u.align || "left",
                d = t.verticalAlign || u.verticalAlign || "top", f = h, g = Hn(c, i.contentHeight, d);
            if (r || n) {
                var y = i.width;
                n && (y += n[1] + n[3]);
                var v = Gn(h, y, p), m = Hn(c, a, d);
                r && this._renderBackground(t, t, v, m, y, a)
            }
            g += l / 2, n && (f = ds(h, p, n), "top" === d ? g += n[0] : "bottom" === d && (g -= n[2]));
            for (var _, x = 0, b = !1, w = (null == (_ = "fill" in t ? t.fill : (b = !0, u.fill)) || "none" === _ ? null : _.image || _.colorStops ? "#000" : _), S = (ps("stroke" in t ? t.stroke : o || u.autoStroke && !b ? null : (x = 2, u.stroke))), M = t.textShadowBlur > 0, I = null != t.width && ("truncate" === t.overflow || "break" === t.overflow || "breakAll" === t.overflow), T = i.calculatedLineHeight, C = 0; C < s.length; C++) {
                var A = this._getOrCreateChild(qa), D = A.createStyle();
                A.useStyle(D), D.text = s[C], D.x = f, D.y = g, p && (D.textAlign = p), D.textBaseline = "middle", D.opacity = t.opacity, D.strokeFirst = !0, M && (D.shadowBlur = t.textShadowBlur || 0, D.shadowColor = t.textShadowColor || "transparent", D.shadowOffsetX = t.textShadowOffsetX || 0, D.shadowOffsetY = t.textShadowOffsetY || 0), S && (D.stroke = S, D.lineWidth = t.lineWidth || x, D.lineDash = t.lineDash, D.lineDashOffset = t.lineDashOffset || 0), w && (D.fill = w), D.font = e, g += l, I && A.setBoundingRect(new Rn(Gn(D.x, t.width, D.textAlign), Hn(D.y, T, D.textBaseline), t.width, T))
            }
            ...
            var t = this.style, e = function (t, e) {
                    ...
                    for (var i, r = e.width, o = e.height, a = e.overflow, s = "break" !== a && "breakAll" !== a || null == r ? null : {
                        ...
                        accumWidth: 0,
                        breakAll: "breakAll" === a
                    }, l = io.lastIndex = 0; null != (i = io.exec(t));) {
                        var u = i.index;
                        u > l && co(n, t.substring(l, u), e, s), co(n, i[2], e, s, i[1]), l = io.lastIndex
                    }
                    l < t.length && co(n, t.substring(l, t.length), e, s);
                    ...
                    t:for (var v = 0; v < n.lines.length; v++) {
                        for (var m = n.lines[v], _ = 0, x = 0, b = 0; b < m.tokens.length; b++) {
                            var w = (P = m.tokens[b]).styleName && e.rich[P.styleName] || {}, S = P.textPadding = w.padding,
                                M = S ? S[1] + S[3] : 0, I = P.font = w.font || e.font;
                            P.contentHeight = Wn(I);
                            var T = tt(w.height, P.contentHeight);
                            if (P.innerHeight = T, S && (T += S[0] + S[2]), P.height = T, P.lineHeight = et(w.lineHeight, e.lineHeight, T), P.align = w && w.align || e.align, P.verticalAlign = w && w.verticalAlign || "middle", g && null != o && c + P.lineHeight > o) {
                                b > 0 ? (m.tokens = m.tokens.slice(0, b), y(m, x, _), n.lines = n.lines.slice(0, v + 1)) : n.lines = n.lines.slice(0, v);
                                break t
                            }
                            var C = w.width, A = null == C || "auto" === C;
                            if ("string" == typeof C && "%" === C.charAt(C.length - 1)) P.percentWidth = C, h.push(P), P.contentWidth = Bn(P.text, I); else {
                                if (A) {
                                    var D = w.backgroundColor, L = D && D.image;
                                    L && no(L = Qr(L)) && (P.width = Math.max(P.width, L.width * T / L.height))
                                }
                                var k = f && null != r ? r - x : null;
                                null != k && k < P.width ? !A || k < M ? (P.text = "", P.width = P.contentWidth = 0) : (P.text = ro(P.text, k - M, I, e.ellipsis, {minChar: e.truncateMinChar}), P.width = P.contentWidth = Bn(P.text, I)) : P.contentWidth = Bn(P.text, I)
                            }
                            P.width += M, x += P.width, w && (_ = Math.max(_, P.lineHeight))
                        }
                        y(m, x, _)
                    }
                    for (n.outerWidth = n.width = tt(r, p), n.outerHeight = n.height = tt(o, c), n.contentHeight = c, n.contentWidth = p, d && (n.outerWidth += d[1] + d[3], n.outerHeight += d[0] + d[2]), v = 0; v < h.length; v++) {
                        var P, O = (P = h[v]).percentWidth;
                        P.width = parseInt(O, 10) / 100 * n.width
                    }
                    return n
                }(fs(t), t), n = e.width, i = e.outerWidth, r = e.outerHeight, o = t.padding, a = t.x || 0, s = t.y || 0,
                l = this._defaultStyle, u = t.align || l.align, h = t.verticalAlign || l.verticalAlign, c = Gn(a, i, u),
                p = Hn(s, r, h), d = c, f = p;
            o && (d += o[3], f += o[0]);
            var g = d + n;
            gs(t) && this._renderBackground(t, t, c, p, i, r);
            for (var y = !!t.backgroundColor, v = 0; v < e.lines.length; v++) {
                for (var m = e.lines[v], _ = m.tokens, x = _.length, b = m.lineHeight, w = m.width, S = 0, M = d, I = g, T = x - 1, C = void 0; S < x && (!(C = _[S]).align || "left" === C.align);) this._placeToken(C, t, b, f, M, "left", y), w -= C.width, M += C.width, S++;
                for (; T >= 0 && "right" === (C = _[T]).align;) this._placeToken(C, t, b, f, I, "right", y), w -= C.width, I -= C.width, T--;
                for (M += (n - (M - d) - (g - I) - w) / 2; S <= T;) C = _[S], this._placeToken(C, t, b, f, M + C.width / 2, "center", y), M += C.width, S++;
                f += b
            }
            ...
            "top" === l ? u = i + t.height / 2 : "bottom" === l && (u = i + n - t.height / 2), !t.isLineHolder && gs(s) && this._renderBackground(s, e, "right" === o ? r - t.width : "center" === o ? r - t.width / 2 : r, u - t.height / 2, t.width, t.height);
            var h = !!s.backgroundColor, c = t.textPadding;
            c && (r = ds(r, o, c), u -= t.height / 2 - c[0] - t.innerHeight / 2);
            var p = this._getOrCreateChild(qa), d = p.createStyle();
            p.useStyle(d);
            var f = this._defaultStyle, g = !1, y = 0,
                v = ps("fill" in s ? s.fill : "fill" in e ? e.fill : (g = !0, f.fill)),
                m = ps("stroke" in s ? s.stroke : "stroke" in e ? e.stroke : h || a || f.autoStroke && !g ? null : (y = 2, f.stroke)),
                _ = s.textShadowBlur > 0 || e.textShadowBlur > 0;
            d.text = t.text, d.x = r, d.y = u, _ && (d.shadowBlur = s.textShadowBlur || e.textShadowBlur || 0, d.shadowColor = s.textShadowColor || e.textShadowColor || "transparent", d.shadowOffsetX = s.textShadowOffsetX || e.textShadowOffsetX || 0, d.shadowOffsetY = s.textShadowOffsetY || e.textShadowOffsetY || 0), d.textAlign = o, d.textBaseline = "middle", d.font = t.font || En, d.opacity = et(s.opacity, e.opacity, 1), m && (d.lineWidth = et(s.lineWidth, e.lineWidth, y), d.lineDash = tt(s.lineDash, e.lineDash), d.lineDashOffset = e.lineDashOffset || 0, d.stroke = m), v && (d.fill = v);
            var x = t.contentWidth, b = t.contentHeight;
            p.setBoundingRect(new Rn(Gn(d.x, x, d.textAlign), Hn(d.y, b, d.textBaseline), x, b))
        }, e.prototype._renderBackground = function (t, e, n, i, r, o) {
            var a, s, l, u = t.backgroundColor, h = t.borderWidth, c = t.borderColor, p = H(u), d = t.borderRadius,
                f = this;
            if (p || h && c) {
                (a = this._getOrCreateChild(os)).useStyle(a.createStyle()), a.style.fill = null;
                var g = a.shape;
                g.x = n, g.y = i, g.width = r, g.height = o, g.r = d, a.dirtyShape()
            }
            if (p) (l = a.style).fill = u || null, l.fillOpacity = tt(t.fillOpacity, 1); else if (u && u.image) {
                (s = this._getOrCreateChild(Ja)).onload = function () {
                    f.dirtyStyle()
                };
                var y = s.style;
                y.image = u.image, y.x = n, y.y = i, y.width = r, y.height = o
            }
            h && c && ((l = a.style).lineWidth = h, l.stroke = c, l.strokeOpacity = tt(t.strokeOpacity, 1), l.lineDash = t.borderDash, l.lineDashOffset = t.borderDashOffset || 0, a.strokeContainThreshold = 0, a.hasFill() && a.hasStroke() && (l.strokeFirst = !0, l.lineWidth *= 2));
            var v = (a || s).style;
            v.shadowBlur = t.shadowBlur || 0, v.shadowColor = t.shadowColor || "transparent", v.shadowOffsetX = t.shadowOffsetX || 0, v.shadowOffsetY = t.shadowOffsetY || 0, v.opacity = et(t.opacity, e.opacity, 1)
            ...
            return e && ot(e) || t.textFont || t.font
        }, e
    }(xo), us = {left: !0, right: 1, center: 1}, hs = {top: 1, bottom: 1, middle: 1};

    function cs(t) {
        if (t) {
            t.font = ls.makeFont(t);
            var e = t.align;
            "middle" === e && (e = "center"), t.align = null == e || us[e] ? e : "left";
            var n = t.verticalAlign;
            "center" === n && (n = "middle"), t.verticalAlign = null == n || hs[n] ? n : "top", t.padding && (t.padding = it(t.padding))
        }
    }
    ...
    var ys = Lr(), vs = 1, ms = {}, _s = Lr(), xs = ["emphasis", "blur", "select"],
        bs = ["normal", "emphasis", "blur", "select"], ws = "highlight", Ss = "downplay", Ms = "select",
        Is = "unselect", Ts = "toggleSelect";
    ...
    function Bs(t, e, n) {
        zs(t, e, n), t.isGroup && t.traverse((function (t) {
            zs(t, e, n)
        }))
    }
    ...
    function Fs(t, e) {
        ...
        if (this.style) {
            if ("emphasis" === t) return function (t, e, n, i) {
                var r = n && A(n, "select") >= 0, o = !1;
                if (t instanceof Za) {
                    var a = _s(t), s = r && a.selectFill || a.normalFill, l = r && a.selectStroke || a.normalStroke;
                    if (Cs(s) || Cs(l)) {
                        var u = (i = i || {}).style || {};
                        !Cs(u.fill) && Cs(s) ? (o = !0, i = I({}, i), (u = I({}, u)).fill = Ds(s)) : !Cs(u.stroke) && Cs(l) && (o || (i = I({}, i), u = I({}, u)), u.stroke = Ds(l)), i.style = u
                    }
                }
                if (i && null == i.z2) {
                    o || (i = I({}, i));
            ...
            if ("blur" === t) return function (t, e, n) {
                var i = A(t.currentStates, e) >= 0, r = t.style.opacity, o = i ? null : function (t, e, n, i) {
                ...
                return null == a.opacity && (n = I({}, n), a = I({opacity: i ? r : .1 * o.opacity}, a), n.style = a), n
            }(this, t, n);
    ...
    function Gs(t) {
        ...
        e && (e.stateProxy = Fs), n && (n.stateProxy = Fs)
    }

    function Hs(t, e) {
        t.__highByOuter |= 1 << (e || 0), Bs(t, ks)
    }

    function Ws(t, e) {
        !(t.__highByOuter &= ~(1 << (e || 0))) && Bs(t, Ps)
    }
    ...
    function qs(t, e, n, i, r) {
        ...
        if (n = n || "coordinateSystem", r) {
            if (null != t && e && "none" !== e) {
                var s = o.getSeriesByIndex(t), l = s.coordinateSystem;
                l && l.master && (l = l.master);
                var u = [];
                o.eachSeries((function (t) {
                    var r = s === t, o = t.coordinateSystem;
                    if (o && o.master && (o = o.master), !("series" === n && !r || "coordinateSystem" === n && !(o && l ? o === l : r) || "series" === e && r)) {
                        if (i.getViewOfSeriesModel(t).group.traverse((function (t) {
                            Os(t)
                        })), k(e)) a(t.getData(), e); else if (X(e)) for (var h = z(e), c = 0; c < h.length; c++) a(t.getData(h[c]), e[h[c]]);
                        u.push(t)
                    }
                })), o.eachComponent((function (t, e) {
                    if ("series" !== t) {
                        var n = i.getViewOfComponentModel(e);
                        n && n.blurSeries && n.blurSeries(u, o)
                    }
                }))
            }
        } else !function (t) {
    ...
    var tl = ["emphasis", "blur", "select"],
        el = {itemStyle: "getItemStyle", lineStyle: "getLineStyle", areaStyle: "getAreaStyle"};

    function nl(t, e, n, i) {
        n = n || "itemStyle";
        for (var r = 0; r < tl.length; r++) {
            var o = tl[r], a = e.getModel([o, n]);
    ...
    var sl = Ca.CMD, ll = [[], [], []], ul = Math.sqrt, hl = Math.atan2;
    var cl = Math.sqrt, pl = Math.sin, dl = Math.cos, fl = Math.PI;
    ...
    function ml(t, e, n, i, r, o, a, s, l, u, h) {
        var c = l * (fl / 180), p = dl(c) * (t - n) / 2 + pl(c) * (e - i) / 2,
            d = -1 * pl(c) * (t - n) / 2 + dl(c) * (e - i) / 2, f = p * p / (a * a) + d * d / (s * s);
        f > 1 && (a *= cl(f), s *= cl(f));
        var g = (r === o ? -1 : 1) * cl((a * a * (s * s) - a * a * (d * d) - s * s * (p * p)) / (a * a * (d * d) + s * s * (p * p))) || 0,
            y = g * a * d / s, v = g * -s * p / a, m = (t + n) / 2 + dl(c) * y - pl(c) * v,
            _ = (e + i) / 2 + pl(c) * y + dl(c) * v, x = vl([1, 0], [(p - y) / a, (d - v) / s]),
            b = [(p - y) / a, (d - v) / s], w = [(-1 * p - y) / a, (-1 * d - v) / s], S = vl(b, w);
        if (yl(b, w) <= -1 && (S = fl), yl(b, w) >= 1 && (S = 0), S < 0) {
            var M = Math.round(S / fl * 1e6) / 1e6;
            S = 2 * fl + M % 2 * fl
        }
        h.addData(u, m, _, a, s, x, S, c, o)
    }

    var _l = /([mlvhzcqtsa])([^mlvhzcqtsa]*)/gi, xl = /-?([0-9]*\.)?[0-9]+([eE]-?[0-9]+)?/g;
    var bl = function (t) {
        function e() {
            return null !== t && t.apply(this, arguments) || this
        }
    ...
    function Sl(t, e) {
        var n = function (t) {
            var e = new Ca;
            if (!t) return e;
            var n, i = 0, r = 0, o = i, a = r, s = Ca.CMD, l = t.match(_l);
            if (!l) return e;
            for (var u = 0; u < l.length; u++) {
                for (var h = l[u], c = h.charAt(0), p = void 0, d = h.match(xl) || [], f = d.length, g = 0; g < f; g++) d[g] = parseFloat(d[g]);
                for (var y = 0; y < f;) {
                    var v = void 0, m = void 0, _ = void 0, x = void 0, b = void 0, w = void 0, S = void 0, M = i,
                    ...
                    switch (c) {
                        ...
                        case"t":
                            ...
                            break;
                        case"A":
                            _ = d[y++], x = d[y++], b = d[y++], w = d[y++], S = d[y++], ml(M = i, I = r, i = d[y++], r = d[y++], w, S, _, x, b, p = s.A, e);
                            break;
                        case"a":
                            _ = d[y++], x = d[y++], b = d[y++], w = d[y++], S = d[y++], ml(M = i, I = r, i += d[y++], r += d[y++], w, S, _, x, b, p = s.A, e)
                    }
        ...
        return i.buildPath = function (t) {
            ...
            !function (t, e) {
                var n, i, r, o, a, s, l = t.data, u = t.len(), h = sl.M, c = sl.C, p = sl.L, d = sl.R, f = sl.A,
                    g = sl.Q;
                for (r = 0, o = 0; r < u;) {
                    switch (n = l[r++], o = r, i = 0, n) {
                        ...
                        case g:
                            ...
                            break;
                        case f:
                            var y = e[4], v = e[5], m = ul(e[0] * e[0] + e[1] * e[1]),
                                _ = ul(e[2] * e[2] + e[3] * e[3]), x = hl(-e[1] / _, e[0] / m);
                            l[r] *= m, l[r++] += y, l[r] *= _, l[r++] += v, l[r++] *= m, l[r++] *= _, l[r++] += x, l[r++] += x, o = r += 2;
                            break;
                        case d:
                            s[0] = l[r++], s[1] = l[r++], Rt(s, s, e), l[o++] = s[0], l[o++] = s[1], s[0] += l[r++], s[1] += l[r++], Rt(s, s, e), l[o++] = s[0], l[o++] = s[1]
                    }
                    for (a = 0; a < i; a++) {
                        var b = ll[a];
                        b[0] = l[r++], b[1] = l[r++], Rt(b, b, e), l[o++] = b[0], l[o++] = b[1]
                    }
                }
                t.increaseVersion()
            }(n, t), this.dirtyShape()
    ...
    Al.prototype.type = "ellipse";
    var Dl = Math.PI, Ll = 2 * Dl, kl = Math.sin, Pl = Math.cos, Ol = Math.acos, Rl = Math.atan2, Nl = Math.abs,
        El = Math.sqrt, zl = Math.max, Bl = Math.min, Vl = 1e-4;

    function Fl(t, e, n, i, r, o, a) {
        var s = t - n, l = e - i, u = (a ? o : -o) / El(s * s + l * l), h = u * l, c = -u * s, p = t + h, d = e + c,
            f = n + h, g = i + c, y = (p + f) / 2, v = (d + g) / 2, m = f - p, _ = g - d, x = m * m + _ * _, b = r - o,
            w = p * g - f * d, S = (_ < 0 ? -1 : 1) * El(zl(0, b * b * x - w * w)), M = (w * _ - m * S) / x,
            I = (-w * m - _ * S) / x, T = (w * _ + m * S) / x, C = (-w * m + _ * S) / x, A = M - y, D = I - v,
            L = T - y, k = C - v;
    ...
    function Gl(t, e) {
        var n = zl(e.r, 0), i = zl(e.r0 || 0, 0), r = n > 0;
        if (r || i > 0) {
            if (r || (n = i, i = 0), i > n) {
                var o = n;
                n = i, i = o
            ...
            var c = e.cx, p = e.cy, d = e.cornerRadius || 0, f = e.innerCornerRadius || 0;
            if (n > Vl) if (a > Ll - Vl) t.moveTo(c + n * Pl(l), p + n * kl(l)), t.arc(c, p, n, l, u, !s), i > Vl && (t.moveTo(c + i * Pl(u), p + i * kl(u)), t.arc(c, p, i, u, l, s)); else {
                var g = Nl(n - i) / 2, y = Bl(g, d), v = Bl(g, f), m = v, _ = y, x = n * Pl(l), b = n * kl(l),
                    w = i * Pl(u), S = i * kl(u), M = void 0, I = void 0, T = void 0, C = void 0;
                if ((y > Vl || v > Vl) && (M = n * Pl(u), I = n * kl(u), T = i * Pl(l), C = i * kl(l), a < Dl)) {
                    var A = function (t, e, n, i, r, o, a, s) {
                        var l = n - t, u = i - e, h = a - r, c = s - o, p = c * l - h * u;
                        if (!(p * p < Vl)) return [t + (p = (h * (e - o) - c * (t - r)) / p) * l, e + p * u]
                    }(x, b, T, C, M, I, w, S);
                    if (A) {
                        var D = x - A[0], L = b - A[1], k = M - A[0], P = I - A[1],
                            O = 1 / kl(Ol((D * k + L * P) / (El(D * D + L * L) * El(k * k + P * P))) / 2),
                            R = El(A[0] * A[0] + A[1] * A[1]);
                        m = Bl(v, (i - R) / (O - 1)), _ = Bl(y, (n - R) / (O + 1))
                    }
                }
                if (a > Vl) if (_ > Vl) {
                    var N = Fl(T, C, x, b, n, _, s), E = Fl(M, I, w, S, n, _, s);
                    t.moveTo(c + N.cx + N.x01, p + N.cy + N.y01), _ < y ? t.arc(c + N.cx, p + N.cy, _, Rl(N.y01, N.x01), Rl(E.y01, E.x01), !s) : (t.arc(c + N.cx, p + N.cy, _, Rl(N.y01, N.x01), Rl(N.y11, N.x11), !s), t.arc(c, p, n, Rl(N.cy + N.y11, N.cx + N.x11), Rl(E.cy + E.y11, E.cx + E.x11), !s), t.arc(c + E.cx, p + E.cy, _, Rl(E.y11, E.x11), Rl(E.y01, E.x01), !s))
                } else t.moveTo(c + x, p + b), t.arc(c, p, n, l, u, !s); else t.moveTo(c + x, p + b);
                if (i > Vl && a > Vl) if (m > Vl) {
                    N = Fl(w, S, M, I, i, -m, s), E = Fl(x, b, T, C, i, -m, s);
                    t.lineTo(c + N.cx + N.x01, p + N.cy + N.y01), m < v ? t.arc(c + N.cx, p + N.cy, m, Rl(N.y01, N.x01), Rl(E.y01, E.x01), !s) : (t.arc(c + N.cx, p + N.cy, m, Rl(N.y01, N.x01), Rl(N.y11, N.x11), !s), t.arc(c, p, i, Rl(N.cy + N.y11, N.cx + N.x11), Rl(E.cy + E.y11, E.cx + E.x11), s), t.arc(c + E.cx, p + E.cy, m, Rl(E.y11, E.x11), Rl(E.y01, E.x01), !s))
                } else t.lineTo(c + w, p + S), t.arc(c, p, i, u, l, s); else t.lineTo(c + w, p + S)
            } else t.moveTo(c, p);
            t.closePath()
        }
    }
        ...
        if (r && r.length >= 2) {
            if (i && "spline" !== i) {
                var o = function (t, e, n, i) {
                    ...
                    if (i) {
                        a = [1 / 0, 1 / 0], s = [-1 / 0, -1 / 0];
                        for (var p = 0, d = t.length; p < d; p++) Nt(a, a, t[p]), Et(s, s, t[p]);
                        Nt(a, a, i[0]), Et(s, s, i[1])
                    }
                    for (p = 0, d = t.length; p < d; p++) {
                        ...
                        wt(u, o, r), Ct(u, u, e);
                        var g = Dt(f, r), y = Dt(f, o), v = g + y;
                        0 !== v && (g /= v, y /= v), Ct(h, u, -g), Ct(c, u, y);
                        var m = xt([], f, h), _ = xt([], f, c);
                        i && (Et(m, m, a), Nt(m, m, s), Et(_, _, a), Nt(_, _, s)), l.push(m), l.push(_)
                    }
                ...
                "spline" === i && (r = function (t, e) {
                    for (var n = t.length, i = [], r = 0, o = 1; o < n; o++) r += Dt(t[o - 1], t[o]);
                    var a = r / 2;
                    for (a = a < n ? n : a, o = 0; o < a; o++) {
                        var s = o / (a - 1) * (e ? n : n - 1), l = Math.floor(s), u = s - l, h = void 0, c = t[l % n],
                            p = void 0, d = void 0;
                        e ? (h = t[(l - 1 + n) % n], p = t[(l + 1) % n], d = t[(l + 2) % n]) : (h = t[0 === l ? l : l - 1], p = t[l > n - 2 ? n - 1 : l + 1], d = t[l > n - 3 ? n - 1 : l + 2]);
                        var f = u * u, g = u * f;
                        i.push([Ul(h[0], c[0], p[0], d[0], u, f, g), Ul(h[1], c[1], p[1], d[1], u, f, g)])
                    }
                    return i
    ...
    function iu(t, e, n) {
        ...
        return null === i || null === r ? [(n ? No : Ro)(t.x1, t.cpx1, t.cpx2, t.x2, e), (n ? No : Ro)(t.y1, t.cpy1, t.cpy2, t.y2, e)] : [(n ? Ho : Go)(t.x1, t.cpx1, t.x2, e), (n ? Ho : Go)(t.y1, t.cpy1, t.y2, e)]
    }
    ...
    var ru = function (t) {
        ...
        return n(e, t), e.prototype.getDefaultStyle = function () {
            ...
            0 !== h && (t.moveTo(n, i), null == l || null == u ? (h < 1 && (Yo(n, a, r, h, eu), a = eu[1], r = eu[2], Yo(i, s, o, h, eu), s = eu[1], o = eu[2]), t.quadraticCurveTo(a, s, r, o)) : (h < 1 && (Bo(n, a, l, r, h, eu), a = eu[1], l = eu[2], r = eu[3], Bo(i, s, u, o, h, eu), s = eu[1], u = eu[2], o = eu[3]), t.bezierCurveTo(a, s, l, u, r, o)))
        }, e.prototype.pointAt = function (t) {
            return iu(this.shape, t, !1)
        }, e.prototype.tangentAt = function (t) {
            var e = iu(this.shape, t, !0);
            return At(e, e)
        }, e
    }(Za);
    ru.prototype.type = "bezier-curve";
    var ou = function () {
    ...
    var su = function (t) {
        ...
        return n(e, t), e
    }(lu), cu = [0, 0], pu = [0, 0], du = new In, fu = new In, gu = function () {
        function t(t, e) {
            this._corners = [], this._axes = [], this._origin = [0, 0];
            for (var n = 0; n < 4; n++) this._corners[n] = new In;
            for (n = 0; n < 2; n++) this._axes[n] = new In;
        ...
        return t.prototype.fromBoundingRect = function (t, e) {
            ...
            In.sub(i[0], n[1], n[0]), In.sub(i[1], n[3], n[0]), i[0].normalize(), i[1].normalize();
            for (l = 0; l < 2; l++) this._origin[l] = i[l].dot(n[0])
        }, t.prototype.intersect = function (t, e) {
            var n = !0, i = !e;
            return du.set(1 / 0, 1 / 0), fu.set(0, 0), !this._intersectCheckOneSide(this, t, du, fu, i, 1) && (n = !1, i) || !this._intersectCheckOneSide(t, this, du, fu, i, -1) && (n = !1, i) || i || In.copy(e, n ? du : fu), n
        }, t.prototype._intersectCheckOneSide = function (t, e, n, i, r, o) {
            for (var a = !0, s = 0; s < 2; s++) {
                var l = this._axes[s];
                if (this._getProjMinMaxOnAxis(s, t._corners, cu), this._getProjMinMaxOnAxis(s, e._corners, pu), cu[1] < pu[0] || cu[0] > pu[1]) {
                    if (a = !1, r) return a;
                    var u = Math.abs(pu[0] - cu[1]), h = Math.abs(cu[0] - pu[1]);
                    Math.min(u, h) > i.len() && (u < h ? In.scale(i, l, -u * o) : In.scale(i, l, h * o))
                } else if (n) {
                    u = Math.abs(pu[0] - cu[1]), h = Math.abs(cu[0] - pu[1]);
                    Math.min(u, h) < n.len() && (u < h ? In.scale(n, l, u * o) : In.scale(n, l, -h * o))
                }
            }
            return a
        ...
        return n(e, t), e.prototype.traverse = function (t, e) {
            ...
            if (!this._rect) {
                for (var t = new Rn(1 / 0, 1 / 0, -1 / 0, -1 / 0), e = 0; e < this._displayables.length; e++) {
                    ...
                    n.needLocalTransform() && i.applyTransform(n.getLocalTransform(yu)), t.union(i)
                }
                this._rect = t
            }
            return this._rect
    ...
    function Iu(t) {
        if (xu.hasOwnProperty(t)) return xu[t]
    }

    function Tu(t, e, n, i) {
        var r = Ml(t, e);
        return n && ("center" === i && (n = Au(n, r.getBoundingRect())), Lu(r, n)), r
    }
    ...
    function Pu(t, e, n, i, r, o, a) {
        var s, l = !1;
        "function" == typeof r ? (a = o, o = r, r = null) : X(r) && (o = r.cb, a = r.during, l = r.isFrom, s = r.removeOpt, r = r.dataIndex);
        ...
        if (c || e.stopAnimation("remove"), d) {
            ...
            u ? (f = u.duration || 0, g = u.easing || "cubicOut", y = u.delay || 0) : c ? (f = tt((s = s || {}).duration, 200), g = tt(s.easing, "cubicOut"), y = 0) : (f = i.getShallow(h ? "animationDurationUpdate" : "animationDuration"), g = i.getShallow(h ? "animationEasingUpdate" : "animationEasing"), y = i.getShallow(h ? "animationDelayUpdate" : "animationDelay")), "function" == typeof y && (y = y(r, i.getAnimationDelayParams ? i.getAnimationDelayParams(e, r) : null)), "function" == typeof f && (f = f(r)), f > 0 ? l ? e.animateFrom(n, {
                duration: f,
                delay: y || 0,
                easing: g,
                done: o,
    ...
    function Nu(t, e, n, i, r, o) {
        Bu(t) || Pu("remove", t, e, n, i, r, o)
    }

    function Eu(t, e, n, i) {
        t.removeTextContent(), t.removeTextGuideLine(), Nu(t, {style: {opacity: 0}}, e, n, i)
    }
    ...
    function Vu(t, e) {
        for (var n = ge([]); t && t !== e;) ve(n, t.getLocalTransform(), n), t = t.parent;
        return n
    }

    function Fu(t, e, n) {
        return e && !k(e) && (e = ke.getLocalTransform(e)), n && (e = be([], e)), Rt([], t, e)
    }
    ...
    function Gu(t, e, n) {
        ...
        return o = Fu(o, e, n), Math.abs(o[0]) > Math.abs(o[1]) ? o[0] > 0 ? "right" : "left" : o[1] > 0 ? "bottom" : "top"
    }
        ...
        if (t && e) {
            ...
            e.traverse((function (t) {
                if (Hu(t) && t.anid) {
                    ...
                    if (e) {
                        var i = o(t);
                        t.attr(o(e)), Ou(t, i, n, ys(t).dataIndex)
                    }
                }
            }))
        }
    ...
    function Yu(t, e) {
        return O(t, (function (t) {
            var n = t[0];
            n = mu(n, e.x), n = _u(n, e.x + e.width);
            var i = t[1];
            return i = mu(i, e.y), [n, i = _u(i, e.y + e.height)]
        }))
    }

    function Xu(t, e) {
        var n = mu(t.x, e.x), i = _u(t.x + t.width, e.x + e.width), r = mu(t.y, e.y),
            o = _u(t.y + t.height, e.y + e.height);
        if (i >= n && o >= r) return {x: n, y: r, width: i - n, height: o - r}
    }

    function Uu(t, e, n) {
        var i = I({rectHover: !0}, e), r = i.style = {strokeNoScale: !0};
        if (n = n || {
            x: -1,
            y: -1,
            width: 2,
            height: 2
        }, t) return 0 === t.indexOf("image://") ? (r.image = t.slice(8), T(r, n), new Ja(i)) : Tu(t.replace("path://", ""), i, n, "center")
    }

    function Zu(t, e, n, i, r) {
        for (var o = 0, a = r[r.length - 1]; o < r.length; o++) {
            var s = r[o];
            if (ju(t, e, n, i, s[0], s[1], a[0], a[1])) return !0;
            a = s
        }
    }

    function ju(t, e, n, i, r, o, a, s) {
        var l, u = n - t, h = i - e, c = a - r, p = s - o, d = qu(c, p, u, h);
        if ((l = d) <= 1e-6 && l >= -1e-6) return !1;
        var f = t - r, g = e - o, y = qu(f, g, u, h) / d;
        if (y < 0 || y > 1) return !1;
        var v = qu(f, g, c, p) / d;
        return !(v < 0 || v > 1)
    }
    ...
    Mu("circle", Tl), Mu("ellipse", Al), Mu("sector", Wl), Mu("ring", Xl), Mu("polygon", ql), Mu("polyline", $l), Mu("rect", os), Mu("line", tu), Mu("bezierCurve", ru), Mu("arc", au);
    var Ku = Object.freeze({
        ...
        clipRectByRect: Xu,
        createIcon: Uu,
        linePolygonIntersect: Zu,
        lineLineIntersect: ju,
        Group: zi,
        Image: Ja,
        Text: ls,
        Circle: Tl,
        ...
        BezierCurve: ru,
        Arc: au,
        IncrementalDisplayable: vu,
        CompoundPath: su,
        LinearGradient: uu,
        RadialGradient: hu,
        BoundingRect: Rn,
        OrientedBoundingRect: gu,
        Point: In,
        Path: Za
    }), $u = {};
    ...
    function Ju(t, e) {
        for (var n = 0; n < xs.length; n++) {
            var i = xs[n], r = e[i], o = t.ensureState(i);
    ...
    function Qu(t, e, n) {
        ...
        r && (i = r.getFormattedLabel(o, "normal", null, a, s && s.get("formatter"), null != n ? {interpolatedValue: n} : null)), null == i && (i = G(t.defaultText) ? t.defaultText(o, t, n) : t.defaultText);
        for (var l = {normal: i}, u = 0; u < xs.length; u++) {
            var h = xs[u], c = e[h];
            l[h] = tt(r ? r.getFormattedLabel(o, h, null, a, c && c.get("formatter")) : null, i)
        }
        return l
    }
    ...
    function th(t, e, n, i) {
        n = n || $u;
        for (var r = t instanceof ls, o = !1, a = 0; a < bs.length; a++) {
            if ((p = e[bs[a]]) && p.getShallow("show")) {
                o = !0;
                break
            }
        }
        ...
        if (o) {
            r || (s || (s = new ls, t.setTextContent(s)), t.stateProxy && (s.stateProxy = t.stateProxy));
            var l = Qu(n, e), u = e.normal, h = !!u.getShallow("show"), c = nh(u, i && i.normal, n, !1, !r);
            c.text = l.normal, r || t.setTextConfig(ih(u, n, !1));
            for (a = 0; a < xs.length; a++) {
                var p, d = xs[a];
                if (p = e[d]) {
                    var f = s.ensureState(d), g = !!tt(p.getShallow("show"), h);
                    if (g !== h && (f.ignore = !g), f.style = nh(p, i && i[d], n, !0, !r), f.style.text = l[d], !r) t.ensureState(d).textConfig = ih(p, n, !0)
                }
            }
            s.silent = !!u.getShallow("silent"), null != s.style.x && (c.x = s.style.x), null != s.style.y && (c.y = s.style.y), s.ignore = !h, s.useStyle(c), s.dirty(), n.enableTextSetter && (uh(s).setLabelText = function (t) {
                var i = Qu(n, e, t);
                Ju(s, i)
            })
        } else s && (s.ignore = !0);
    ...
    function eh(t, e) {
        e = e || "label";
        for (var n = {normal: t.getModel(e)}, i = 0; i < xs.length; i++) {
            var r = xs[i];
            n[r] = t.getModel([r, e])
        }
        return n
    ...
    function ih(t, e, n) {
        e = e || {};
        var i, r = {}, o = t.getShallow("rotate"), a = tt(t.getShallow("distance"), n ? null : 5),
    ...
    var rh = ["fontStyle", "fontWeight", "fontSize", "fontFamily", "textShadowColor", "textShadowBlur", "textShadowOffsetX", "textShadowOffsetY"],
        oh = ["align", "lineHeight", "width", "height", "tag", "verticalAlign"],
        ah = ["padding", "borderWidth", "borderRadius", "borderDashOffset", "backgroundColor", "borderColor", "shadowColor", "shadowBlur", "shadowOffsetX", "shadowOffsetY"];

    function sh(t, e, n, i, r, o, a, s) {
        n = !r && n || $u;
        var l = i && i.inheritColor, u = e.getShallow("color"), h = e.getShallow("textBorderColor"),
            c = tt(e.getShallow("opacity"), n.opacity);
        ...
        var p = tt(e.getShallow("textBorderWidth"), n.textBorderWidth);
        null != p && (t.lineWidth = p);
        var d = tt(e.getShallow("textBorderType"), n.textBorderType);
        null != d && (t.lineDash = d);
        var f = tt(e.getShallow("textBorderDashOffset"), n.textBorderDashOffset);
        ...
        for (var g = 0; g < rh.length; g++) {
            var y = rh[g];
            null != (m = tt(e.getShallow(y), n[y])) && (t[y] = m)
        }
        for (g = 0; g < oh.length; g++) {
            y = oh[g];
    ...
    function lh(t, e) {
        ...
        return ot([t.fontStyle || n && n.getShallow("fontStyle") || "", t.fontWeight || n && n.getShallow("fontWeight") || "", (t.fontSize || n && n.getShallow("fontSize") || 12) + "px", t.fontFamily || n && n.getShallow("fontFamily") || "sans-serif"].join(" "))
    }
    ...
    function ch(t, e, n, i, r) {
        var o = uh(t);
        if (o.valueAnimation) {
            var a = o.defaultInterpolatedText, s = tt(o.interpolatedValue, o.prevValue), l = o.value;
            (null == s ? Ru : Ou)(t, {}, i, e, null, (function (i) {
                var u = Br(n, o.precision, s, l, i);
                o.interpolatedValue = 1 === i ? null : u;
                var h = Qu({labelDataIndex: e, labelFetcher: r, defaultText: a ? a(u) : u + ""}, o.statesModels, u);
                Ju(t, h)
            }))
        }
    }

    var ph, dh, fh = ["textStyle", "color"], gh = new ls, yh = function () {
            function t() {
            }

            return t.prototype.getTextColor = function (t) {
                var e = this.ecModel;
                return this.getShallow("color") || (!t && e ? e.get(fh) : null)
                ...
                }), gh.update(), gh.getBoundingRect()
            }, t
        }(),
        vh = [["lineWidth", "width"], ["stroke", "color"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"], ["lineDash", "type"], ["lineDashOffset", "dashOffset"], ["lineCap", "cap"], ["lineJoin", "join"], ["miterLimit"]],
        mh = qr(vh), _h = function () {
            function t() {
            }
        ...
        xh = [["fill", "color"], ["stroke", "borderColor"], ["lineWidth", "borderWidth"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"], ["lineDash", "borderType"], ["lineDashOffset", "borderDashOffset"], ["lineCap", "borderCap"], ["lineJoin", "borderJoin"], ["miterLimit", "borderMiterLimit"]],
        bh = qr(xh), wh = function () {
            function t() {
            }
            ...
            return t.prototype.init = function (t, e, n) {
                ...
                return new (0, this.constructor)(w(this.option))
    ...
    Hr(Sh), ph = Sh, dh = ["__\0is_clz", Xr++].join("_"), ph.prototype[dh] = !0, ph.isInstance = function (t) {
        return !(!t || !t[dh])
    }, L(Sh, _h), L(Sh, wh), L(Sh, $r), L(Sh, yh);
    var Mh = Math.round(10 * Math.random());
    ...
    var Ch = "ZH", Ah = "EN", Dh = Ah, Lh = {}, kh = {},
        Ph = a.domSupported && (document.documentElement.lang || navigator.language || navigator.browserLanguage).toUpperCase().indexOf(Ch) > -1 ? Ch : Dh;

    function Oh(t, e) {
        t = t.toUpperCase(), kh[t] = new Sh(e), Lh[t] = e
    }
    ...
    var Rh = 1e3, Nh = 6e4, Eh = 36e5, zh = 864e5, Bh = 31536e6, Vh = {
            year: "{yyyy}",
            month: "{MMM}",
            day: "{d}",
            hour: "{HH}:{mm}",
            ...
            month: "{yyyy}-{MM}",
            day: Fh,
            hour: "{yyyy}-{MM}-{dd} " + Vh.hour,
            minute: "{yyyy}-{MM}-{dd} " + Vh.minute,
            second: "{yyyy}-{MM}-{dd} " + Vh.second,
            millisecond: Vh.none
        }, Hh = ["year", "month", "day", "hour", "minute", "second", "millisecond"],
    ...
    function Zh(t, e, n, i) {
        var r = rr(t), o = r[Kh(n)](), a = r[$h(n)]() + 1, s = Math.floor((a - 1) / 4) + 1, l = r[Jh(n)](),
            u = r["get" + (n ? "UTC" : "") + "Day"](), h = r[Qh(n)](), c = (h - 1) % 12 + 1, p = r[tc(n)](),
            d = r[ec(n)](), f = r[nc(n)](), g = (i instanceof Sh ? i : function (t) {
                return kh[t]
            }(i || Ph) || kh.EN).getModel("time"), y = g.get("month"), v = g.get("monthAbbr"), m = g.get("dayOfWeek"),
            _ = g.get("dayOfWeekAbbr");
        return (e || "").replace(/{yyyy}/g, o + "").replace(/{yy}/g, o % 100 + "").replace(/{Q}/g, s + "").replace(/{MMMM}/g, y[a - 1]).replace(/{MMM}/g, v[a - 1]).replace(/{MM}/g, Yh(a, 2)).replace(/{M}/g, a + "").replace(/{dd}/g, Yh(l, 2)).replace(/{d}/g, l + "").replace(/{eeee}/g, m[u]).replace(/{ee}/g, _[u]).replace(/{e}/g, u + "").replace(/{HH}/g, Yh(h, 2)).replace(/{H}/g, h + "").replace(/{hh}/g, Yh(c + "", 2)).replace(/{h}/g, c + "").replace(/{mm}/g, Yh(p, 2)).replace(/{m}/g, p + "").replace(/{ss}/g, Yh(d, 2)).replace(/{s}/g, d + "").replace(/{SSS}/g, Yh(f, 3)).replace(/{S}/g, f + "")
    }

    function jh(t, e) {
        var n = rr(t), i = n[$h(e)]() + 1, r = n[Jh(e)](), o = n[Qh(e)](), a = n[tc(e)](), s = n[ec(e)](),
            l = 0 === n[nc(e)](), u = l && 0 === s, h = u && 0 === a, c = h && 0 === o, p = c && 1 === r;
        return p && 1 === i ? "year" : p ? "month" : c ? "day" : h ? "hour" : u ? "minute" : l ? "second" : "millisecond"
    }

    function qh(t, e, n) {
        var i = "number" == typeof t ? rr(t) : t;
        switch (e = e || jh(t, n)) {
            case"year":
                return i[Kh(n)]();
            case"half-year":
    ...
    function gc(t) {
        return null == t ? "" : (t + "").replace(dc, (function (t, e) {
            return fc[e]
        }))
    }
    ...
    function yc(t, e, n) {
        ...
        if (o || a) {
            var s = o ? rr(t) : t;
            if (!isNaN(+s)) return Zh(s, "yyyy-MM-dd hh:mm:ss", n);
            if (a) return "-"
        }
        if ("ordinal" === e) return W(t) ? i(t) : Y(t) && r(t) ? t + "" : "-";
        var l = hr(t);
        return r(l) ? hc(l) : W(t) ? i(t) : "-"
    }

    var vc = ["a", "b", "c", "d", "e", "f", "g"], mc = function (t, e) {
        return "{" + t + (null == e ? "" : e) + "}"
    };
    ...
    function _c(t, e, n) {
        ...
        for (var r = e[0].$vars || [], o = 0; o < r.length; o++) {
            var a = vc[o];
            t = t.replace(mc(a), mc(a, 0))
        }
        for (var s = 0; s < i; s++) for (var l = 0; l < r.length; l++) {
            var u = e[s][r[l]];
            t = t.replace(mc(vc[l], s), n ? gc(u) : u)
        }
        return t
    }

    function xc(t, e) {
        var n = H(t) ? {color: t, extraCssText: e} : t || {}, i = n.color, r = n.type;
        e = n.extraCssText;
        var o = n.renderMode || "html";
        return i ? "html" === o ? "subItem" === r ? '<span style="display:inline-block;vertical-align:middle;margin-right:8px;margin-left:3px;border-radius:4px;width:4px;height:4px;background-color:' + gc(i) + ";" + (e || "") + '"></span>' : '<span style="display:inline-block;margin-right:4px;border-radius:10px;width:10px;height:10px;background-color:' + gc(i) + ";" + (e || "") + '"></span>' : {
            renderMode: o,
    ...
    function bc(t, e) {
        return e = e || "transparent", H(t) ? t : X(t) && t.colorStops && (t.colorStops[0] || {}).color || e
    }
    ...
    var Sc = P, Mc = ["left", "right", "top", "bottom", "width", "height"],
        Ic = [["width", "left", "right"], ["height", "top", "bottom"]];
    ...
    function Ac(t, e, n) {
        n = pc(n || 0);
        var i = e.width, r = e.height, o = Zi(t.left, i), a = Zi(t.top, r), s = Zi(t.right, i), l = Zi(t.bottom, r),
            u = Zi(t.width, i), h = Zi(t.height, r), c = n[2] + n[0], p = n[1] + n[3], d = t.aspect;
    ...
    function Dc(t, e, n, i, r) {
        ...
        if (o || a) {
            var l;
            if ("raw" === s) l = "group" === t.type ? new Rn(0, 0, +e.width || 0, +e.height || 0) : t.getBoundingRect(); else if (l = t.getBoundingRect(), t.needLocalTransform()) {
                var u = t.getLocalTransform();
                (l = l.clone()).applyTransform(u)
            }
            var h = Ac(T({width: l.width, height: l.height}, e), n, i), c = o ? h.x - l.x : 0, p = a ? h.y - l.y : 0;
            "raw" === s ? (t.x = c, t.y = p) : (t.x += c, t.y += p), t.markRedraw()
        }
    }

    function Lc(t) {
        var e = t.layoutMode || t.constructor.layoutMode;
        return X(e) ? e : e ? {type: e} : null
    }

    function kc(t, e, n) {
        var i = n && n.ignoreSize;
        !F(i) && (i = [i, i]);
        var r = a(Ic[0], 0), o = a(Ic[1], 1);
    ...
    function Oc(t, e) {
        return e && t && Sc(Mc, (function (n) {
            e.hasOwnProperty(n) && (t[n] = e[n])
        })), t
    }

    var Rc = Lr(), Nc = function (t) {
        function e(e, n, i) {
        ...
        return n(e, t), e.prototype.init = function (t, e, n) {
            ...
            var n = Lc(this), i = n ? Pc(t) : {};
            S(t, e.getTheme().get(this.mainType)), S(t, this.getDefaultOption()), n && kc(t, i, n)
        }, e.prototype.mergeOption = function (t, e) {
            S(this.option, t, !0);
            var n = Lc(this);
            n && kc(this.option, t, n)
            ...
            return Nr(this.ecModel, t, {index: this.get(n, !0), id: this.get(i, !0)}, e)
    ...
    Yr(Nc, Sh), jr(Nc), function (t) {
            ...
            if (t.length) {
                var a = function (t) {
                    ...
                    return P(t, (function (o) {
                        ...
                        a.entryCount = s.length, 0 === a.entryCount && r.push(o), P(s, (function (t) {
                ...
                for (P(t, (function (t) {
                    ...
                    p && (r.call(o, h, c.originalDeps.slice()), delete u[h]), P(c.successor, p ? f : d)
                }
                P(u, (function () {
                    var t = "";
                    throw new Error(t)
        ...
        var e = [];
        P(Nc.getClassesByMainType(t), (function (t) {
    ...
    var Ec = "";
    "undefined" != typeof navigator && (Ec = navigator.platform || "");
    var zc = "rgba(0, 0, 0, 0.2)", Bc = {
            darkMode: "auto",
            ...
            aria: {
                decal: {
                    decals: [{
                        ...
                        dashArrayY: [6, 0],
                        symbolSize: .8
                    }, {color: zc, dashArrayX: [1, 0], dashArrayY: [4, 3], rotation: -Math.PI / 4}, {
                        color: zc,
            ...
            textStyle: {
                fontFamily: Ec.match(/^Win/) ? "Microsoft YaHei" : "sans-serif",
                fontSize: 12,
                fontStyle: "normal",
                fontWeight: "normal"
            },
            ...
            useUTC: !1
        }, Vc = ht(["tooltip", "label", "itemName", "itemId", "seriesName"]), Fc = "original", Gc = "arrayRows",
        Hc = "objectRows", Wc = "keyedColumns", Yc = "typedArray", Xc = "unknown", Uc = "column", Zc = "row", jc = 1,
        qc = 2, Kc = 3, $c = Lr();

    function Jc(t, e, n) {
        var i = {}, r = tp(e);
        if (!r || !t) return i;
        var o, a, s = [], l = [], u = e.ecModel, h = $c(u).datasetMap, c = r.uid + "_" + n.seriesLayoutBy;
        P(t = t.slice(), (function (e, n) {
            var r = X(e) ? e : t[n] = {name: e};
    ...
    function Qc(t, e, n) {
        ...
        o !== Hc && o !== Wc || P(a, (function (t, e) {
            "name" === (X(t) ? t.name : t) && (r = e)
        }));
        var s = function () {
            for (var t = {}, i = {}, s = [], l = 0, u = Math.min(5, n); l < u; l++) {
                var h = np(e.data, o, e.seriesLayoutBy, a, e.startIndex, l);
                s.push(h);
                var c = h === Kc;
                if (c && null == t.v && l !== r && (t.v = l), (null == t.n || t.n === t.v || !c && s[t.n] === Kc) && (t.n = l), p(t) && s[t.n] !== Kc) return t;
                c || (h === qc && null == i.v && l !== r && (i.v = l), null != i.n && i.n !== i.v || (i.n = l))
            }
    ...
    function tp(t) {
        if (!t.get("data", !0)) return Nr(t.ecModel, "dataset", {
    ...
    function ep(t, e) {
        return np(t.data, t.sourceFormat, t.seriesLayoutBy, t.dimensionsDefine, t.startIndex, e)
    }
    ...
    function np(t, e, n, i, r, o) {
        ...
        if (i) {
            var u = i[o];
            X(u) ? (s = u.name, l = u.type) : H(u) && (s = u)
        }
        if (null != l) return "ordinal" === l ? jc : Kc;
        if (e === Gc) {
            var h = t;
            if (n === Zc) {
        ...
        function m(t) {
            var e = H(t);
            return null != t && isFinite(t) && "" !== t ? e ? qc : Kc : e && "-" !== t ? jc : void 0
        }
    ...
    var ip = ht();
    var rp, op, ap, sp = Lr(), lp = Lr(), up = function () {
        function t() {
        }

        return t.prototype.getColorFromPalette = function (t, e, n) {
            var i = _r(this.get("color", !0)), r = this.get("colorLayer", !0);
            return cp(this, sp, i, r, t, e, n)
    ...
    function hp(t, e, n, i) {
        var r = _r(t.get(["aria", "decal", "decals"]));
        return cp(t, lp, r, null, e, n, i)
    }

    function cp(t, e, n, i, r, o, a) {
    ...
    var pp = function (t) {
        ...
        return n(e, t), e.prototype.init = function (t, e, n, i, r, o) {
            i = i || {}, this.option = null, this._theme = new Sh(i), this._locale = new Sh(r), this._optionManager = o
            ...
            return this._resetOption(t, gp(e))
        }, e.prototype._resetOption = function (t, e) {
            var n = !1, i = this._optionManager;
            if (!t || "recreate" === t) {
                var r = i.mountOption("recreate" === t);
                this.option && "recreate" !== t ? (this.restoreData(), this._mergeOption(r, e)) : ap(this, r), n = !0
            }
            ...
            var n = this.option, i = this._componentsMap, r = this._componentsCount, o = [], a = ht(),
                s = e && e.replaceMergeMainTypeMap;
            $c(this).datasetMap = ht(), P(t, (function (t, e) {
                null != t && (Nc.hasClass(e) ? e && (o.push(e), a.set(e, !0)) : n[e] = null == n[e] ? w(t) : S(n[e], t, !0))
            })), s && s.each((function (t, e) {
                Nc.hasClass(e) && !a.get(e) && (o.push(e), a.set(e, !0))
            })), Nc.topologicalTravel(o, Nc.getAllClassMainTypes(), (function (e) {
                var o = function (t, e, n) {
                        var i = ip.get(e);
                        if (!i) return n;
                        var r = i(t);
                        return r ? n.concat(r) : n
                    }(this, e, _r(t[e])), a = i.get(e),
                    l = a ? s && s.get(e) ? "replaceMerge" : "normalMerge" : "replaceAll", u = Sr(a, o, l);
                (function (t, e, n) {
                    P(t, (function (t) {
                        var i = t.newOption;
                        X(i) && (t.keyInfo.mainType = e, t.keyInfo.subType = function (t, e, n, i) {
                            return e.type ? e.type : n ? n.subType : i.determineSubType(t, e)
                        }(e, i, t.existing, n))
                    }))
                })(u, e, Nc), n[e] = null, i.set(e, null), r.set(e, 0);
                var h = [], c = [], p = 0;
                P(u, (function (t, n) {
                    var i = t.existing, r = t.newOption;
                    if (r) {
                        var o = Nc.getClass(e, t.keyInfo.subType, !0);
                        if (i && i.constructor === o) i.name = t.keyInfo.name, i.mergeOption(r, this), i.optionUpdated(r, !1); else {
                            var a = I({componentIndex: n}, t.keyInfo);
                            I(i = new o(r, this, this, a), a), t.brandNew && (i.__requireNewView = !0), i.init(r, this, this), i.optionUpdated(null, !0)
                        }
                    } else i && (i.mergeOption({}, this), i.optionUpdated({}, !1));
                    i ? (h.push(i.option), c.push(i), p++) : (h.push(void 0), c.push(void 0))
                }), this), n[e] = h, i.set(e, c), r.set(e, p), "series" === e && rp(this)
            }), this), this._seriesIndices || rp(this)
        }, e.prototype.getOption = function () {
            var t = w(this.option);
            return P(t, (function (e, n) {
                if (Nc.hasClass(n)) {
                    for (var i = _r(e), r = i.length, o = !1, a = r - 1; a >= 0; a--) i[a] && !Ar(i[a]) ? o = !0 : (i[a] = null, !o && r--);
                    i.length = r, t[n] = i
                }
            })), delete t["\0_ec_inner"], t
            ...
            return a && a.length ? (null != i ? (n = [], P(_r(i), (function (t) {
                a[t] && n.push(a[t])
            }))) : n = null != r ? dp("id", r, a) : null != o ? dp("name", o, a) : N(a, (function (t) {
                return !!t
            })), fp(n, t)) : []
            ...
            var e, n, i, r, o, a = t.query, s = t.mainType,
                l = (n = s + "Index", i = s + "Id", r = s + "Name", !(e = a) || null == e[n] && null == e[i] && null == e[r] ? null : {
                    ...
                    id: e[i],
                    name: e[r]
                }), u = l ? this.queryComponents(l) : N(this._componentsMap.get(s), (function (t) {
                    return !!t
                }));
            return o = fp(u, t), t.filter ? N(o, t.filter) : o
            ...
            op(this), P(this._seriesIndices, (function (i) {
            ...
            return op(this), null == this._seriesIndicesMap.get(t.componentIndex)
            ...
            }), this), this._seriesIndices = n, this._seriesIndicesMap = ht(n)
        }, e.prototype.restoreData = function (t) {
            rp(this);
            var e = this._componentsMap, n = [];
            e.each((function (t, e) {
                Nc.hasClass(e) && n.push(e)
            })), Nc.topologicalTravel(n, Nc.getAllClassMainTypes(), (function (n) {
                P(e.get(n), (function (e) {
        ...
        }, e.internalField = (rp = function (t) {
            var e = t._seriesIndices = [];
            P(t._componentsMap.get("series"), (function (t) {
                t && e.push(t.componentIndex)
            })), t._seriesIndicesMap = ht(e)
        }, op = function (t) {
        }, void (ap = function (t, e) {
            t.option = {}, t.option["\0_ec_inner"] = 1, t._componentsMap = ht({series: []}), t._componentsCount = ht();
            var n = e.aria;
            X(n) && null == n.enabled && (n.enabled = !0), function (t, e) {
                var n = t.color && !t.colorLayer;
                P(e, (function (e, i) {
                    "colorLayer" === i && n || Nc.hasClass(i) || ("object" == typeof e ? t[i] = t[i] ? S(t[i], e, !1) : w(e) : null == t[i] && (t[i] = e))
                }))
            }(e, t._theme.option), S(e, Bc, !1), t._mergeOption(e, null)
        })), e
    }(Sh);
    ...
    function dp(t, e, n) {
        if (F(e)) {
            ...
            return P(e, (function (t) {
                null != t && (null != Tr(t, null) && i.set(t, !0))
            })), N(n, (function (e) {
                return e && i.get(e[t])
            }))
        }
    ...
    function fp(t, e) {
        return e.hasOwnProperty("subType") ? N(t, (function (t) {
    ...
    function gp(t) {
        var e = ht();
        return t && P(_r(t.replaceMerge), (function (t) {
            e.set(t, !0)
        })), {replaceMergeMainTypeMap: e}
    }

    L(pp, up);
    var yp = ["getDom", "getZr", "getWidth", "getHeight", "getDevicePixelRatio", "dispatchAction", "isDisposed", "on", "off", "getDataURL", "getConnectedDataURL", "getOption", "getId", "updateLabelLayout"],
        vp = function (t) {
            P(yp, (function (e) {
                this[e] = B(t[e], t)
            }), this)
        ...
        }(), xp = /^(min|max)?(.+)$/, bp = function () {
            function t(t) {
                this._timelineOptions = [], this._mediaList = [], this._currentMediaIndices = [], this._api = t
            }

            return t.prototype.setOption = function (t, e, n) {
                t && (P(_r(t.series), (function (t) {
                    t && t.data && Z(t.data) && st(t.data)
                })), P(_r(t.dataset), (function (t) {
                    t && t.source && Z(t.source) && st(t.source)
                }))), t = w(t);
                ...
                return this._timelineOptions = e.timelineOptions, this._mediaList = e.mediaList, this._mediaDefault = e.mediaDefault, this._currentMediaIndices = [], w(t ? e.baseOption : this._newBaseOption)
            }, t.prototype.getTimelineOption = function (t) {
                var e, n = this._timelineOptions;
                if (n.length) {
                    var i = t.getComponent("timeline");
                    i && (e = w(n[i.getCurrentIndex()]))
                }
                return e
                ...
                for (var u = 0, h = o.length; u < h; u++) wp(o[u].query, i, r) && s.push(u);
                return !s.length && a && (s = [-1]), s.length && (e = s, n = this._currentMediaIndices, e.join(",") !== n.join(",")) && (l = O(s, (function (t) {
                    return w(-1 === t ? a.option : o[t].option)
    ...
    var Sp = P, Mp = X, Ip = ["areaStyle", "lineStyle", "nodeStyle", "linkStyle", "chordStyle", "label", "labelLine"];

    function Tp(t) {
        var e = t && t.itemStyle;
        if (e) for (var n = 0, i = Ip.length; n < i; n++) {
            var r = Ip[n], o = e.normal, a = e.emphasis;
            o && o[r] && (t[r] = t[r] || {}, t[r].normal ? S(t[r].normal, o[r]) : t[r].normal = o[r], o[r] = null), a && a[r] && (t[r] = t[r] || {}, t[r].emphasis ? S(t[r].emphasis, a[r]) : t[r].emphasis = a[r], a[r] = null)
        }
    }
    ...
    function Cp(t, e, n) {
        if (t && t[e] && (t[e].normal || t[e].emphasis)) {
            ...
            i && (n ? (t[e].normal = t[e].emphasis = null, T(t[e], i)) : t[e] = i), r && (t.emphasis = t.emphasis || {}, t.emphasis[e] = r, r.focus && (t.emphasis.focus = r.focus), r.blurScope && (t.emphasis.blurScope = r.blurScope))
        }
    }

    function Ap(t) {
        Cp(t, "itemStyle"), Cp(t, "lineStyle"), Cp(t, "areaStyle"), Cp(t, "label"), Cp(t, "labelLine"), Cp(t, "upperLabel"), Cp(t, "edgeLabel")
    }
    ...
    function Lp(t) {
        t && (Ap(t), Dp(t, "label"), t.emphasis && Dp(t.emphasis, "label"))
    }
    ...
    function Op(t, e) {
        Sp(kp(t.series), (function (t) {
            Mp(t) && function (t) {
                if (Mp(t)) {
                    Tp(t), Ap(t), Dp(t, "label"), Dp(t, "upperLabel"), Dp(t, "edgeLabel"), t.emphasis && (Dp(t.emphasis, "label"), Dp(t.emphasis, "upperLabel"), Dp(t.emphasis, "edgeLabel"));
                    var e = t.markPoint;
                    e && (Tp(e), Lp(e));
                    var n = t.markLine;
                    n && (Tp(n), Lp(n));
                    ...
                    if ("graph" === t.type) {
                        ...
                        if (o && !Z(o)) for (var a = 0; a < o.length; a++) Lp(o[a]);
                        P(t.categories, (function (t) {
                            Ap(t)
                        }))
                    }
                    if (r && !Z(r)) for (a = 0; a < r.length; a++) Lp(r[a]);
                    if ((e = t.markPoint) && e.data) {
                        var s = e.data;
                        for (a = 0; a < s.length; a++) Lp(s[a])
                    }
                    if ((n = t.markLine) && n.data) {
                        var l = n.data;
                        for (a = 0; a < l.length; a++) F(l[a]) ? (Lp(l[a][0]), Lp(l[a][1])) : Lp(l[a])
                    }
                    "gauge" === t.type ? (Dp(t, "axisLabel"), Dp(t, "title"), Dp(t, "detail")) : "treemap" === t.type ? (Cp(t.breadcrumb, "itemStyle"), P(t.levels, (function (t) {
                        Ap(t)
                    }))) : "tree" === t.type && Ap(t.leaves)
                }
            }(t)
        }));
        var n = ["xAxis", "yAxis", "radiusAxis", "angleAxis", "singleAxis", "parallelAxis", "radar"];
        e && n.push("valueAxis", "categoryAxis", "logAxis", "timeAxis"), Sp(n, (function (e) {
            Sp(kp(t[e]), (function (t) {
                t && (Dp(t, "axisLabel"), Dp(t.axisPointer, "label"))
            }))
        })), Sp(kp(t.parallel), (function (t) {
            var e = t && t.parallelAxisDefault;
            Dp(e, "axisLabel"), Dp(e && e.axisPointer, "label")
        })), Sp(kp(t.calendar), (function (t) {
            Cp(t, "itemStyle"), Dp(t, "dayLabel"), Dp(t, "monthLabel"), Dp(t, "yearLabel")
        })), Sp(kp(t.radar), (function (t) {
            Dp(t, "name"), t.name && null == t.axisName && (t.axisName = t.name, delete t.name), null != t.nameGap && null == t.axisNameGap && (t.axisNameGap = t.nameGap, delete t.nameGap)
        })), Sp(kp(t.geo), (function (t) {
            Mp(t) && (Lp(t), Sp(kp(t.regions), (function (t) {
                Lp(t)
            })))
        })), Sp(kp(t.timeline), (function (t) {
            Lp(t), Cp(t, "label"), Cp(t, "itemStyle"), Cp(t, "controlStyle", !0);
            var e = t.data;
            F(e) && P(e, (function (t) {
                X(t) && (Cp(t, "label"), Cp(t, "itemStyle"))
            }))
        })), Sp(kp(t.toolbox), (function (t) {
            Cp(t, "iconStyle"), Sp(t.feature, (function (t) {
                Cp(t, "iconStyle")
            }))
        })), Dp(Pp(t.axisPointer), "label"), Dp(Pp(t.tooltip).axisPointer, "label")
    }
    ...
    var Np = [["x", "left"], ["y", "top"], ["x2", "right"], ["y2", "bottom"]],
        Ep = ["grid", "geo", "parallel", "legend", "toolbox", "title", "visualMap", "dataZoom", "timeline"],
        zp = [["borderRadius", "barBorderRadius"], ["borderColor", "barBorderColor"], ["borderWidth", "barBorderWidth"]];

    function Bp(t) {
        var e = t && t.itemStyle;
        if (e) for (var n = 0; n < zp.length; n++) {
            var i = zp[n][1], r = zp[n][0];
            null != e[i] && (e[r] = e[i])
        }
    }
    ...
    function Gp(t, e) {
        if (t) for (var n = 0; n < t.length; n++) e(t[n]), t[n] && Gp(t[n].children, e)
    }

    function Hp(t, e) {
        Op(t, e), t.series = _r(t.series), P(t.series, (function (t) {
            if (X(t)) {
                var e = t.type;
                if ("line" === e) null != t.clipOverflow && (t.clip = t.clipOverflow); else if ("pie" === e || "gauge" === e) {
                    if (null != t.clockWise && (t.clockwise = t.clockWise), Vp(t.label), (r = t.data) && !Z(r)) for (var n = 0; n < r.length; n++) Vp(r[n]);
                    ...
                    var r;
                    if (Bp(t), Bp(t.backgroundStyle), Bp(t.emphasis), (r = t.data) && !Z(r)) for (n = 0; n < r.length; n++) "object" == typeof r[n] && (Bp(r[n]), Bp(r[n] && r[n].emphasis))
                } else if ("sunburst" === e) {
                    var o = t.highlightPolicy;
                    o && (t.emphasis = t.emphasis || {}, t.emphasis.focus || (t.emphasis.focus = o)), Fp(t), Gp(t.data, Fp)
                ...
                }(t) : "map" === e && (t.mapType && !t.map && (t.map = t.mapType), t.mapLocation && T(t, t.mapLocation));
                null != t.hoverAnimation && (t.emphasis = t.emphasis || {}, t.emphasis && null == t.emphasis.scale && (t.emphasis.scale = t.hoverAnimation)), Rp(t)
            }
        })), t.dataRange && (t.visualMap = t.dataRange), P(Ep, (function (e) {
            var n = t[e];
            n && (F(n) || (n = [n]), P(n, (function (t) {
                Rp(t)
            })))
        }))
    }
        ...
        P(t, (function (e, n) {
            var i = [], r = [NaN, NaN], o = [e.stackResultDimension, e.stackedOverDimension], a = e.data,
                s = e.isStackedByIndex, l = a.map(o, (function (o, l, u) {
                    ...
                    return i[0] = p, i[1] = d, i
                }));
            a.hostModel.setData(l), e.data = l
        }))
    }

    var Yp, Xp, Up, Zp, jp, qp = function (t) {
        this.data = t.data || (t.sourceFormat === Wc ? {} : []), this.sourceFormat = t.sourceFormat || Xc, this.seriesLayoutBy = t.seriesLayoutBy || Uc, this.startIndex = t.startIndex || 0, this.dimensionsDefine = t.dime